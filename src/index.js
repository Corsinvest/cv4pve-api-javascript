/*
 * This file is part of the cv4pve-api-javascript https://github.com/Corsinvest/cv4pve-api-javascript,
 *
...
class PveClientBase {
    ...
    async #execute(method, resource, parameters) {
        ...
        var tmpParameters = Object.create({});
        ...
        var body = '';
        var headers = {};
        var url = '/api2/json' + resource;
        var urlParams = new URLSearchParams(parameters).toString();
        ...
        return new Promise((resolve, reject) => {
            var req = this.#http.request(options, (response) => {
    ...
    async waitForTaskToFinish(task, wait = 500, timeOut = 10000) {
        return await WaitForTaskToFinish(task.split(':')[1], task, wait, timeOut);
    }
     ...
     * @return {Promise<boolean>}
     */
    async waitForTaskToFinish(node, task, wait = 500, timeOut = 10000) {
        if (wait <= 0) { wait = 500; }
        ...
        return new Promise((resolve, reject) => {
            const interval = setInterval(function () {
                ...
                if (numberInterval * wait >= timeOut) {
                    ...
                    ref.taskIsRunning(node, task).then((running) => {
                        if (!running) {
                            clearInterval(interval);
                            resolve(true);
                        }
     ...
     */
    async taskIsRunning(node, task) { return await this.readTaskStatus(node, task).Response.data.status == "running"; }
     ...
     */
    async getExitStatusTask(node, task) { return await this.readTaskStatus(node, task).response.data.exitstatus; }
     ...
     * @returns {Promise<Result>}
     */
    async readTaskStatus(node, task) { return this.get('/nodes/' + node + '/tasks/' + task + '/status'); }
...
class PVECluster {
     ...
     * @returns {PVEClusterBackup_Info}
     */
    get backup_Info() { return this.#backup_Info == null ? (this.#backup_Info = new PVEClusterBackup_Info(this.#client)) : this.#backup_Info; }
    #ha;
    /**
     * Get ClusterHa
    ...
    * @returns {Result}
    */
    async index() { return await this.getRest(); }
...
class PVEClusterReplication {
    ...
    * @returns {Result}
    */
    async createRest(id, target, type, comment, disable, rate, remove_job, schedule, source) {
        var parameters = {
            'id': id,
            'target': target,
            'type': type,
    ...
    * @returns {Result}
    */
    async create(id, target, type, comment, disable, rate, remove_job, schedule, source) { return await this.createRest(id, target, type, comment, disable, rate, remove_job, schedule, source); }
...
class PVEItemReplicationClusterId {
    ...
    * @returns {Result}
    */
    async delete_(force, keep) { return await this.deleteRest(force, keep); }
    /**
    ...
    * @returns {Result}
    */
    async read() { return await this.getRest(); }
    /**
    ...
    * @returns {Result}
    */
    async setRest(comment, delete_, digest, disable, rate, remove_job, schedule, source) {
        var parameters = {
            'comment': comment,
            'delete': delete_,
            'digest': digest,
    ...
    * @returns {Result}
    */
    async update(comment, delete_, digest, disable, rate, remove_job, schedule, source) { return await this.setRest(comment, delete_, digest, disable, rate, remove_job, schedule, source); }
...
class PVEMetricsClusterServer {
    ...
    * @returns {Result}
    */
    async serverIndex() { return await this.getRest(); }
...
class PVEItemServerMetricsClusterId {
    ...
    * @returns {Result}
    */
    async delete_() { return await this.deleteRest(); }
    /**
    ...
    * @returns {Result}
    */
    async createRest(port, server, type, api_path_prefix, bucket, disable, influxdbproto, max_body_size, mtu, organization, path, proto, timeout, token, verify_certificate) {
        var parameters = {
            'port': port,
            'server': server,
            'type': type,
    ...
    * @returns {Result}
    */
    async create(port, server, type, api_path_prefix, bucket, disable, influxdbproto, max_body_size, mtu, organization, path, proto, timeout, token, verify_certificate) { return await this.createRest(port, server, type, api_path_prefix, bucket, disable, influxdbproto, max_body_size, mtu, organization, path, proto, timeout, token, verify_certificate); }
    /**
    ...
    * @returns {Result}
    */
    async setRest(port, server, api_path_prefix, bucket, delete_, digest, disable, influxdbproto, max_body_size, mtu, organization, path, proto, timeout, token, verify_certificate) {
        var parameters = {
            'port': port,
            'server': server,
            'api-path-prefix': api_path_prefix,
    ...
    * @returns {Result}
    */
    async update(port, server, api_path_prefix, bucket, delete_, digest, disable, influxdbproto, max_body_size, mtu, organization, path, proto, timeout, token, verify_certificate) { return await this.setRest(port, server, api_path_prefix, bucket, delete_, digest, disable, influxdbproto, max_body_size, mtu, organization, path, proto, timeout, token, verify_certificate); }
...
class PVEClusterConfig {
    ...
    * @returns {Result}
    */
    async createRest(clustername, linkN, nodeid, votes) {
        var parameters = {
    ...
    * @returns {Result}
    */
    async create(clustername, linkN, nodeid, votes) { return await this.createRest(clustername, linkN, nodeid, votes); }
...
class PVEConfigClusterApiversion {
    ...
    * @returns {Result}
    */
    async joinApiVersion() { return await this.getRest(); }
...
class PVEConfigClusterNodes {
    ...
    * @returns {Result}
    */
    async nodes() { return await this.getRest(); }
...
class PVEItemNodesConfigClusterNode {
    ...
    * @returns {Result}
    */
    async delnode() { return await this.deleteRest(); }
    /**
    ...
    * @returns {Result}
    */
    async createRest(apiversion, force, linkN, new_node_ip, nodeid, votes) {
        var parameters = {
    ...
    * @returns {Result}
    */
    async addnode(apiversion, force, linkN, new_node_ip, nodeid, votes) { return await this.createRest(apiversion, force, linkN, new_node_ip, nodeid, votes); }
...
class PVEConfigClusterJoin {
    ...
    * @returns {Result}
    */
    async joinInfo(node) { return await this.getRest(node); }
    /**
    ...
    * @returns {Result}
    */
    async createRest(fingerprint, hostname, password, force, linkN, nodeid, votes) {
        var parameters = {
    ...
    * @returns {Result}
    */
    async join(fingerprint, hostname, password, force, linkN, nodeid, votes) { return await this.createRest(fingerprint, hostname, password, force, linkN, nodeid, votes); }
...
class PVEConfigClusterTotem {
    ...
    * @returns {Result}
    */
    async totem() { return await this.getRest(); }
...
class PVEConfigClusterQdevice {
    ...
    * @returns {Result}
    */
    async status() { return await this.getRest(); }
...
class PVEFirewallClusterGroups {
    ...
    * @returns {Result}
    */
    async listSecurityGroups() { return await this.getRest(); }
    /**
    ...
    * @returns {Result}
    */
    async createRest(group, comment, digest, rename) {
        var parameters = {
            'group': group,
            'comment': comment,
            'digest': digest,
    ...
    * @returns {Result}
    */
    async createSecurityGroup(group, comment, digest, rename) { return await this.createRest(group, comment, digest, rename); }
...
class PVEItemGroupsFirewallClusterGroup {
    ...
    * @returns {Result}
    */
    async deleteSecurityGroup() { return await this.deleteRest(); }
    /**
    * List rules.
    * @returns {Result}
    */
    ...
    * @returns {Result}
    */
    async getRules() { return await this.getRest(); }
    /**
    * Create new rule.
    ...
    * @returns {Result}
    */
    async createRest(action, type, comment, dest, digest, dport, enable, icmp_type, iface, log, macro, pos, proto, source, sport) {
        var parameters = {
            'action': action,
            'type': type,
            'comment': comment,
    ...
    * @returns {Result}
    */
    async createRule(action, type, comment, dest, digest, dport, enable, icmp_type, iface, log, macro, pos, proto, source, sport) { return await this.createRest(action, type, comment, dest, digest, dport, enable, icmp_type, iface, log, macro, pos, proto, source, sport); }
...
class PVEItemGroupGroupsFirewallClusterPos {
    ...
    * @returns {Result}
    */
    async deleteRest(digest) {
        var parameters = { 'digest': digest };
    ...
    * @returns {Result}
    */
    async deleteRule(digest) { return await this.deleteRest(digest); }
    /**
    ...
    * @returns {Result}
    */
    async getRule() { return await this.getRest(); }
    /**
    * Modify rule data.
    * @param {string} action Rule action ('ACCEPT', 'DROP', 'REJECT') or security group name.
    * @param {string} comment Descriptive comment.
    ...
    * @returns {Result}
    */
    async setRest(action, comment, delete_, dest, digest, dport, enable, icmp_type, iface, log, macro, moveto, proto, source, sport, type) {
        var parameters = {
            'action': action,
            'comment': comment,
            'delete': delete_,
    ...
    * @returns {Result}
    */
    async updateRule(action, comment, delete_, dest, digest, dport, enable, icmp_type, iface, log, macro, moveto, proto, source, sport, type) { return await this.setRest(action, comment, delete_, dest, digest, dport, enable, icmp_type, iface, log, macro, moveto, proto, source, sport, type); }
...
class PVEFirewallClusterIpset {
    ...
    * @returns {Result}
    */
    async ipsetIndex() { return await this.getRest(); }
    /**
    * Create new IPSet
    ...
    * @returns {Result}
    */
    async createRest(name, comment, digest, rename) {
        var parameters = {
            'name': name,
            'comment': comment,
            'digest': digest,
    ...
    * @returns {Result}
    */
    async createIpset(name, comment, digest, rename) { return await this.createRest(name, comment, digest, rename); }
...
class PVEItemIpsetFirewallClusterName {
    ...
    * @returns {Result}
    */
    async deleteIpset() { return await this.deleteRest(); }
    /**
    * List IPSet content
    * @returns {Result}
    */
    ...
    * @returns {Result}
    */
    async getIpset() { return await this.getRest(); }
    /**
    ...
    * @returns {Result}
    */
    async createRest(cidr, comment, nomatch) {
        var parameters = {
            'cidr': cidr,
            'comment': comment,
            'nomatch': nomatch
    ...
    * @returns {Result}
    */
    async createIp(cidr, comment, nomatch) { return await this.createRest(cidr, comment, nomatch); }
...
class PVEItemNameIpsetFirewallClusterCidr {
    ...
    * @returns {Result}
    */
    async removeIp(digest) { return await this.deleteRest(digest); }
    /**
    ...
    * @returns {Result}
    */
    async readIp() { return await this.getRest(); }
    /**
    ...
    * @returns {Result}
    */
    async setRest(comment, digest, nomatch) {
        var parameters = {
            'comment': comment,
            'digest': digest,
            'nomatch': nomatch
    ...
    * @returns {Result}
    */
    async updateIp(comment, digest, nomatch) { return await this.setRest(comment, digest, nomatch); }
...
class PVEFirewallClusterAliases {
    ...
    * @returns {Result}
    */
    async getAliases() { return await this.getRest(); }
    /**
    ...
    * @returns {Result}
    */
    async createRest(cidr, name, comment) {
        var parameters = {
            'cidr': cidr,
            'name': name,
            'comment': comment
    ...
    * @returns {Result}
    */
    async createAlias(cidr, name, comment) { return await this.createRest(cidr, name, comment); }
...
class PVEItemAliasesFirewallClusterName {
    ...
    * @returns {Result}
    */
    async removeAlias(digest) { return await this.deleteRest(digest); }
    /**
    * Read alias.
    * @returns {Result}
    */
    ...
    * @returns {Result}
    */
    async readAlias() { return await this.getRest(); }
    /**
    ...
    * @returns {Result}
    */
    async setRest(cidr, comment, digest, rename) {
        var parameters = {
            'cidr': cidr,
            'comment': comment,
            'digest': digest,
    ...
    * @returns {Result}
    */
    async updateAlias(cidr, comment, digest, rename) { return await this.setRest(cidr, comment, digest, rename); }
...
class PVEFirewallClusterOptions {
    ...
    * @returns {Result}
    */
    async getOptions() { return await this.getRest(); }
    /**
    ...
    * @returns {Result}
    */
    async setRest(delete_, digest, ebtables, enable, log_ratelimit, policy_in, policy_out) {
        var parameters = {
            'delete': delete_,
            'digest': digest,
            'ebtables': ebtables,
    ...
    * @returns {Result}
    */
    async setOptions(delete_, digest, ebtables, enable, log_ratelimit, policy_in, policy_out) { return await this.setRest(delete_, digest, ebtables, enable, log_ratelimit, policy_in, policy_out); }
...
class PVEFirewallClusterMacros {
    ...
    * @returns {Result}
    */
    async getMacros() { return await this.getRest(); }
...
class PVEFirewallClusterRefs {
    ...
    * @returns {Result}
    */
    async refs(type) { return await this.getRest(type); }
...
class PVEClusterBackup {
    ...
    * @returns {Result}
    */
    async createRest(all, bwlimit, comment, compress, dow, dumpdir, enabled, exclude, exclude_path, id, ionice, lockwait, mailnotification, mailto, maxfiles, mode, node, pigz, pool, prune_backups, quiet, remove, schedule, script, starttime, stdexcludes, stop, stopwait, storage, tmpdir, vmid, zstd) {
        var parameters = {
            'all': all,
            'bwlimit': bwlimit,
            'comment': comment,
    ...
    * @returns {Result}
    */
    async createJob(all, bwlimit, comment, compress, dow, dumpdir, enabled, exclude, exclude_path, id, ionice, lockwait, mailnotification, mailto, maxfiles, mode, node, pigz, pool, prune_backups, quiet, remove, schedule, script, starttime, stdexcludes, stop, stopwait, storage, tmpdir, vmid, zstd) { return await this.createRest(all, bwlimit, comment, compress, dow, dumpdir, enabled, exclude, exclude_path, id, ionice, lockwait, mailnotification, mailto, maxfiles, mode, node, pigz, pool, prune_backups, quiet, remove, schedule, script, starttime, stdexcludes, stop, stopwait, storage, tmpdir, vmid, zstd); }
...
class PVEItemBackupClusterId {
    ...
    * @returns {Result}
    */
    async deleteJob() { return await this.deleteRest(); }
    /**
    ...
    * @returns {Result}
    */
    async readJob() { return await this.getRest(); }
    /**
    ...
    * @returns {Result}
    */
    async setRest(all, bwlimit, comment, compress, delete_, dow, dumpdir, enabled, exclude, exclude_path, ionice, lockwait, mailnotification, mailto, maxfiles, mode, node, pigz, pool, prune_backups, quiet, remove, schedule, script, starttime, stdexcludes, stop, stopwait, storage, tmpdir, vmid, zstd) {
        var parameters = {
            'all': all,
            'bwlimit': bwlimit,
            'comment': comment,
    ...
    * @returns {Result}
    */
    async updateJob(all, bwlimit, comment, compress, delete_, dow, dumpdir, enabled, exclude, exclude_path, ionice, lockwait, mailnotification, mailto, maxfiles, mode, node, pigz, pool, prune_backups, quiet, remove, schedule, script, starttime, stdexcludes, stop, stopwait, storage, tmpdir, vmid, zstd) { return await this.setRest(all, bwlimit, comment, compress, delete_, dow, dumpdir, enabled, exclude, exclude_path, ionice, lockwait, mailnotification, mailto, maxfiles, mode, node, pigz, pool, prune_backups, quiet, remove, schedule, script, starttime, stdexcludes, stop, stopwait, storage, tmpdir, vmid, zstd); }
...
class PVEIdBackupClusterIncludedVolumes {
    ...
    * @returns {Result}
    */
    async getVolumeBackupIncluded() { return await this.getRest(); }
...
class PVEClusterBackup_Info {
     ...
     * @returns {PVEBackup_InfoClusterNot_Backed_Up}
     */
    get not_Backed_Up() { return this.#not_Backed_Up == null ? (this.#not_Backed_Up = new PVEBackup_InfoClusterNot_Backed_Up(this.#client)) : this.#not_Backed_Up; }
...
class PVEBackup_InfoClusterNot_Backed_Up {
    ...
    * @returns {Result}
    */
    async getGuestsNotInBackup() { return await this.getRest(); }
...
class PVEHaClusterResources {
    ...
    * @returns {Result}
    */
    async index(type) { return await this.getRest(type); }
    /**
    ...
    * @returns {Result}
    */
    async createRest(sid, comment, group, max_relocate, max_restart, state, type) {
        var parameters = {
            'sid': sid,
            'comment': comment,
            'group': group,
    ...
    * @returns {Result}
    */
    async create(sid, comment, group, max_relocate, max_restart, state, type) { return await this.createRest(sid, comment, group, max_relocate, max_restart, state, type); }
...
class PVEItemResourcesHaClusterSid {
    ...
    * @returns {Result}
    */
    async setRest(comment, delete_, digest, group, max_relocate, max_restart, state) {
        var parameters = {
            'comment': comment,
            'delete': delete_,
            'digest': digest,
    ...
    * @returns {Result}
    */
    async update(comment, delete_, digest, group, max_relocate, max_restart, state) { return await this.setRest(comment, delete_, digest, group, max_relocate, max_restart, state); }
...
class PVESidResourcesHaClusterMigrate {
    ...
    * @returns {Result}
    */
    async migrate(node) { return await this.createRest(node); }
...
class PVESidResourcesHaClusterRelocate {
    ...
    * @returns {Result}
    */
    async relocate(node) { return await this.createRest(node); }
...
class PVEHaClusterGroups {
    ...
    * @returns {Result}
    */
    async createRest(group, nodes, comment, nofailback, restricted, type) {
        var parameters = {
            'group': group,
            'nodes': nodes,
            'comment': comment,
    ...
    * @returns {Result}
    */
    async create(group, nodes, comment, nofailback, restricted, type) { return await this.createRest(group, nodes, comment, nofailback, restricted, type); }
...
class PVEItemGroupsHaClusterGroup {
    ...
    * @returns {Result}
    */
    async setRest(comment, delete_, digest, nodes, nofailback, restricted) {
        var parameters = {
            'comment': comment,
            'delete': delete_,
            'digest': digest,
    ...
    * @returns {Result}
    */
    async update(comment, delete_, digest, nodes, nofailback, restricted) { return await this.setRest(comment, delete_, digest, nodes, nofailback, restricted); }
...
class PVEStatusHaClusterManagerStatus {
    ...
    * @returns {Result}
    */
    async managerStatus() { return await this.getRest(); }
...
class PVEClusterAcme {
     ...
     * @returns {PVEAcmeClusterChallenge_Schema}
     */
    get challenge_Schema() { return this.#challenge_Schema == null ? (this.#challenge_Schema = new PVEAcmeClusterChallenge_Schema(this.#client)) : this.#challenge_Schema; }
...
class PVEAcmeClusterPlugins {
    ...
    * @returns {Result}
    */
    async createRest(id, type, api, data, disable, nodes, validation_delay) {
        var parameters = {
            'id': id,
            'type': type,
            'api': api,
    ...
    * @returns {Result}
    */
    async addPlugin(id, type, api, data, disable, nodes, validation_delay) { return await this.createRest(id, type, api, data, disable, nodes, validation_delay); }
...
class PVEItemPluginsAcmeClusterId {
    ...
    * @returns {Result}
    */
    async deletePlugin() { return await this.deleteRest(); }
    /**
    ...
    * @returns {Result}
    */
    async getPluginConfig() { return await this.getRest(); }
    /**
    ...
    * @returns {Result}
    */
    async setRest(api, data, delete_, digest, disable, nodes, validation_delay) {
        var parameters = {
            'api': api,
            'data': data,
            'delete': delete_,
    ...
    * @returns {Result}
    */
    async updatePlugin(api, data, delete_, digest, disable, nodes, validation_delay) { return await this.setRest(api, data, delete_, digest, disable, nodes, validation_delay); }
...
class PVEAcmeClusterAccount {
    ...
    * @returns {Result}
    */
    async accountIndex() { return await this.getRest(); }
    /**
    ...
    * @returns {Result}
    */
    async createRest(contact, directory, name, tos_url) {
        var parameters = {
            'contact': contact,
            'directory': directory,
            'name': name,
    ...
    * @returns {Result}
    */
    async registerAccount(contact, directory, name, tos_url) { return await this.createRest(contact, directory, name, tos_url); }
...
class PVEItemAccountAcmeClusterName {
    ...
    * @returns {Result}
    */
    async deactivateAccount() { return await this.deleteRest(); }
    /**
    ...
    * @returns {Result}
    */
    async getAccount() { return await this.getRest(); }
    /**
    * Update existing ACME account information with CA. Note: not specifying any new account information triggers a refresh.
    * @param {string} contact Contact email addresses.
    * @returns {Result}
    */
    async setRest(contact) {
        var parameters = { 'contact': contact };
    ...
    * @returns {Result}
    */
    async updateAccount(contact) { return await this.setRest(contact); }
...
class PVEAcmeClusterTos {
    ...
    * @returns {Result}
    */
    async getTos(directory) { return await this.getRest(directory); }
...
class PVEAcmeClusterDirectories {
    ...
    * @returns {Result}
    */
    async getDirectories() { return await this.getRest(); }
...
class PVEAcmeClusterChallenge_Schema {
    ...
    * @returns {Result}
    */
    async challengeschema() { return await this.getRest(); }
...
class PVEClusterCeph {
    ...
    * @returns {Result}
    */
    async cephindex() { return await this.getRest(); }
...
class PVECephClusterMetadata {
    ...
    * @returns {Result}
    */
    async metadata(scope) { return await this.getRest(scope); }
...
class PVECephClusterFlags {
    ...
    * @returns {Result}
    */
    async getAllFlags() { return await this.getRest(); }
    /**
    ...
    * @returns {Result}
    */
    async setRest(nobackfill, nodeep_scrub, nodown, noin, noout, norebalance, norecover, noscrub, notieragent, noup, pause) {
        var parameters = {
    ...
    * @returns {Result}
    */
    async setFlags(nobackfill, nodeep_scrub, nodown, noin, noout, norebalance, norecover, noscrub, notieragent, noup, pause) { return await this.setRest(nobackfill, nodeep_scrub, nodown, noin, noout, norebalance, norecover, noscrub, notieragent, noup, pause); }
...
class PVEItemFlagsCephClusterFlag {
    ...
    * @returns {Result}
    */
    async getFlag() { return await this.getRest(); }
    /**
    ...
    * @returns {Result}
    */
    async updateFlag(value) { return await this.setRest(value); }
...
class PVEClusterJobs {
    ...
    #schedule_Analyze;
    /**
     * Get JobsClusterSchedule_Analyze
     * @returns {PVEJobsClusterSchedule_Analyze}
     */
    get schedule_Analyze() { return this.#schedule_Analyze == null ? (this.#schedule_Analyze = new PVEJobsClusterSchedule_Analyze(this.#client)) : this.#schedule_Analyze; }
...
/**
 * Class PVEJobsClusterSchedule_Analyze
 */
class PVEJobsClusterSchedule_Analyze {
    ...
    * @returns {Result}
    */
    async getRest(schedule, iterations, starttime) {
        var parameters = {
            'schedule': schedule,
    ...
    * @returns {Result}
    */
    async schedule_Analyze(schedule, iterations, starttime) { return await this.getRest(schedule, iterations, starttime); }
...
class PVEClusterSdn {
    ...
    * @returns {Result}
    */
    async reload() { return await this.setRest(); }
...
class PVESdnClusterVnets {
    ...
    * @returns {Result}
    */
    async index(pending, running) { return await this.getRest(pending, running); }
    /**
    ...
    * @returns {Result}
    */
    async createRest(vnet, zone, alias, tag, type, vlanaware) {
        var parameters = {
            'vnet': vnet,
            'zone': zone,
            'alias': alias,
    ...
    * @returns {Result}
    */
    async create(vnet, zone, alias, tag, type, vlanaware) { return await this.createRest(vnet, zone, alias, tag, type, vlanaware); }
...
class PVEItemVnetsSdnClusterVnet {
    ...
    * @returns {Result}
    */
    async read(pending, running) { return await this.getRest(pending, running); }
    /**
    ...
    * @returns {Result}
    */
    async setRest(alias, delete_, digest, tag, vlanaware, zone) {
        var parameters = {
            'alias': alias,
            'delete': delete_,
            'digest': digest,
    ...
    * @returns {Result}
    */
    async update(alias, delete_, digest, tag, vlanaware, zone) { return await this.setRest(alias, delete_, digest, tag, vlanaware, zone); }
...
class PVEVnetVnetsSdnClusterSubnets {
    ...
    * @returns {Result}
    */
    async createRest(subnet, type, dnszoneprefix, gateway, snat) {
        var parameters = {
            'subnet': subnet,
            'type': type,
    ...
    * @returns {Result}
    */
    async create(subnet, type, dnszoneprefix, gateway, snat) { return await this.createRest(subnet, type, dnszoneprefix, gateway, snat); }
...
class PVEItemSubnetsVnetVnetsSdnClusterSubnet {
    ...
    * @returns {Result}
    */
    async setRest(delete_, digest, dnszoneprefix, gateway, snat) {
        var parameters = {
            'delete': delete_,
            'digest': digest,
            'dnszoneprefix': dnszoneprefix,
    ...
    * @returns {Result}
    */
    async update(delete_, digest, dnszoneprefix, gateway, snat) { return await this.setRest(delete_, digest, dnszoneprefix, gateway, snat); }
...
class PVESdnClusterZones {
    ...
    * @returns {Result}
    */
    async getRest(pending, running, type) {
        var parameters = {
            'pending': pending,
            'running': running,
            'type': type
    ...
    * @returns {Result}
    */
    async index(pending, running, type) { return await this.getRest(pending, running, type); }
    /**
    ...
    * @returns {Result}
    */
    async createRest(type, zone, advertise_subnets, bridge, controller, disable_arp_nd_suppression, dns, dnszone, dp_id, exitnodes, exitnodes_local_routing, ipam, mac, mtu, nodes, peers, reversedns, tag, vlan_protocol, vrf_vxlan) {
        var parameters = {
            'type': type,
            'zone': zone,
...
class PVEItemZonesSdnClusterZone {
    ...
    * @returns {Result}
    */
    async setRest(advertise_subnets, bridge, controller, delete_, digest, disable_arp_nd_suppression, dns, dnszone, dp_id, exitnodes, exitnodes_local_routing, ipam, mac, mtu, nodes, peers, reversedns, tag, vlan_protocol, vrf_vxlan) {
        var parameters = {
            'advertise-subnets': advertise_subnets,
            'bridge': bridge,
            'controller': controller,
    ...
    * @returns {Result}
    */
    async update(advertise_subnets, bridge, controller, delete_, digest, disable_arp_nd_suppression, dns, dnszone, dp_id, exitnodes, exitnodes_local_routing, ipam, mac, mtu, nodes, peers, reversedns, tag, vlan_protocol, vrf_vxlan) { return await this.setRest(advertise_subnets, bridge, controller, delete_, digest, disable_arp_nd_suppression, dns, dnszone, dp_id, exitnodes, exitnodes_local_routing, ipam, mac, mtu, nodes, peers, reversedns, tag, vlan_protocol, vrf_vxlan); }
...
class PVESdnClusterControllers {
    ...
    * @returns {Result}
    */
    async createRest(controller, type, asn, ebgp, ebgp_multihop, loopback, node, peers) {
        var parameters = {
            'controller': controller,
            'type': type,
            'asn': asn,
    ...
    * @returns {Result}
    */
    async create(controller, type, asn, ebgp, ebgp_multihop, loopback, node, peers) { return await this.createRest(controller, type, asn, ebgp, ebgp_multihop, loopback, node, peers); }
...
class PVEItemControllersSdnClusterController {
    ...
    * @returns {Result}
    */
    async setRest(asn, delete_, digest, ebgp, ebgp_multihop, loopback, node, peers) {
        var parameters = {
            'asn': asn,
            'delete': delete_,
            'digest': digest,
    ...
    * @returns {Result}
    */
    async update(asn, delete_, digest, ebgp, ebgp_multihop, loopback, node, peers) { return await this.setRest(asn, delete_, digest, ebgp, ebgp_multihop, loopback, node, peers); }
...
class PVESdnClusterIpams {
    ...
    * @returns {Result}
    */
    async createRest(ipam, type, section, token, url) {
        var parameters = {
            'ipam': ipam,
            'type': type,
            'section': section,
    ...
    * @returns {Result}
    */
    async create(ipam, type, section, token, url) { return await this.createRest(ipam, type, section, token, url); }
...
class PVEItemIpamsSdnClusterIpam {
    ...
    * @returns {Result}
    */
    async setRest(delete_, digest, section, token, url) {
        var parameters = {
            'delete': delete_,
            'digest': digest,
            'section': section,
    ...
    * @returns {Result}
    */
    async update(delete_, digest, section, token, url) { return await this.setRest(delete_, digest, section, token, url); }
...
class PVESdnClusterDns {
    ...
    * @returns {Result}
    */
    async createRest(dns, key, type, url, reversemaskv6, reversev6mask, ttl) {
        var parameters = {
            'dns': dns,
            'key': key,
            'type': type,
    ...
    * @returns {Result}
    */
    async create(dns, key, type, url, reversemaskv6, reversev6mask, ttl) { return await this.createRest(dns, key, type, url, reversemaskv6, reversev6mask, ttl); }
...
class PVEItemDnsSdnClusterDns {
    ...
    * @returns {Result}
    */
    async setRest(delete_, digest, key, reversemaskv6, ttl, url) {
        var parameters = {
            'delete': delete_,
            'digest': digest,
            'key': key,
    ...
    * @returns {Result}
    */
    async update(delete_, digest, key, reversemaskv6, ttl, url) { return await this.setRest(delete_, digest, key, reversemaskv6, ttl, url); }
...
class PVEClusterLog {
    ...
    * @returns {Result}
    */
    async log(max) { return await this.getRest(max); }
...
class PVEClusterResources {
    ...
    * @returns {Result}
    */
    async resources(type) { return await this.getRest(type); }
...
class PVEClusterTasks {
    ...
    * @returns {Result}
    */
    async tasks() { return await this.getRest(); }
...
class PVEClusterOptions {
    ...
    * @returns {Result}
    */
    async setRest(bwlimit, console, delete_, description, email_from, fencing, ha, http_proxy, keyboard, language, mac_prefix, max_workers, migration, migration_unsecure, u2f, webauthn) {
        var parameters = {
            'bwlimit': bwlimit,
            'console': console,
            'delete': delete_,
    ...
    * @returns {Result}
    */
    async setOptions(bwlimit, console, delete_, description, email_from, fencing, ha, http_proxy, keyboard, language, mac_prefix, max_workers, migration, migration_unsecure, u2f, webauthn) { return await this.setRest(bwlimit, console, delete_, description, email_from, fencing, ha, http_proxy, keyboard, language, mac_prefix, max_workers, migration, migration_unsecure, u2f, webauthn); }
...
class PVEClusterStatus {
    ...
    * @returns {Result}
    */
    async getStatus() { return await this.getRest(); }
...
class PVEClusterNextid {
    ...
    * @returns {Result}
    */
    async nextid(vmid) { return await this.getRest(vmid); }
...
class PVEItemNodesNode {
    ...
    #query_Url_Metadata;
    /**
     * Get NodeNodesQuery_Url_Metadata
     * @returns {PVENodeNodesQuery_Url_Metadata}
     */
    get query_Url_Metadata() { return this.#query_Url_Metadata == null ? (this.#query_Url_Metadata = new PVENodeNodesQuery_Url_Metadata(this.#client, this.#node)) : this.#query_Url_Metadata; }
    #report;
    /**
     * Get NodeNodesReport
...
class PVENodeNodesQemu {
    ...
    * @returns {Result}
    */
    async vmlist(full) { return await this.getRest(full); }
    /**
    ...
    * @returns {Result}
    */
    async createVm(vmid, acpi, agent, arch, archive, args, audio0, autostart, balloon, bios, boot, bootdisk, bwlimit, cdrom, cicustom, cipassword, citype, ciuser, cores, cpu, cpulimit, cpuunits, description, efidisk0, force, freeze, hookscript, hostpciN, hotplug, hugepages, ideN, ipconfigN, ivshmem, keephugepages, keyboard, kvm, live_restore, localtime, lock, machine, memory, migrate_downtime, migrate_speed, name, nameserver, netN, numa, numaN, onboot, ostype, parallelN, pool, protection, reboot, rng0, sataN, scsiN, scsihw, searchdomain, serialN, shares, smbios1, smp, sockets, spice_enhancements, sshkeys, start, startdate, startup, storage, tablet, tags, tdf, template, tpmstate0, unique, unusedN, usbN, vcpus, vga, virtioN, vmgenid, vmstatestorage, watchdog) { return await this.createRest(vmid, acpi, agent, arch, archive, args, audio0, autostart, balloon, bios, boot, bootdisk, bwlimit, cdrom, cicustom, cipassword, citype, ciuser, cores, cpu, cpulimit, cpuunits, description, efidisk0, force, freeze, hookscript, hostpciN, hotplug, hugepages, ideN, ipconfigN, ivshmem, keephugepages, keyboard, kvm, live_restore, localtime, lock, machine, memory, migrate_downtime, migrate_speed, name, nameserver, netN, numa, numaN, onboot, ostype, parallelN, pool, protection, reboot, rng0, sataN, scsiN, scsihw, searchdomain, serialN, shares, smbios1, smp, sockets, spice_enhancements, sshkeys, start, startdate, startup, storage, tablet, tags, tdf, template, tpmstate0, unique, unusedN, usbN, vcpus, vga, virtioN, vmgenid, vmstatestorage, watchdog); }
...
class PVEItemQemuNodeNodesVmid {
    ...
    * @returns {Result}
    */
    async deleteRest(destroy_unreferenced_disks, purge, skiplock) {
        var parameters = {
    ...
    * @returns {Result}
    */
    async destroyVm(destroy_unreferenced_disks, purge, skiplock) { return await this.deleteRest(destroy_unreferenced_disks, purge, skiplock); }
    /**
    * Directory index
    * @returns {Result}
    */
    ...
    * @returns {Result}
    */
    async vmdiridx() { return await this.getRest(); }
...
class PVEFirewallVmidQemuNodeNodesOptions {
    ...
    * @returns {Result}
    */
    async setRest(delete_, dhcp, digest, enable, ipfilter, log_level_in, log_level_out, macfilter, ndp, policy_in, policy_out, radv) {
        var parameters = {
            'delete': delete_,
            'dhcp': dhcp,
            'digest': digest,
    ...
    * @returns {Result}
    */
    async setOptions(delete_, dhcp, digest, enable, ipfilter, log_level_in, log_level_out, macfilter, ndp, policy_in, policy_out, radv) { return await this.setRest(delete_, dhcp, digest, enable, ipfilter, log_level_in, log_level_out, macfilter, ndp, policy_in, policy_out, radv); }
...
class PVEFirewallVmidQemuNodeNodesLog {
    ...
    * @returns {Result}
    */
    async log(limit, start) { return await this.getRest(limit, start); }
...
class PVEVmidQemuNodeNodesAgent {
     ...
     * @returns {PVEAgentVmidQemuNodeNodesFsfreeze_Freeze}
     */
    get fsfreeze_Freeze() { return this.#fsfreeze_Freeze == null ? (this.#fsfreeze_Freeze = new PVEAgentVmidQemuNodeNodesFsfreeze_Freeze(this.#client, this.#node, this.#vmid)) : this.#fsfreeze_Freeze; }
    #fsfreeze_Status;
    /**
     * Get AgentVmidQemuNodeNodesFsfreeze_Status
     * @returns {PVEAgentVmidQemuNodeNodesFsfreeze_Status}
     */
    get fsfreeze_Status() { return this.#fsfreeze_Status == null ? (this.#fsfreeze_Status = new PVEAgentVmidQemuNodeNodesFsfreeze_Status(this.#client, this.#node, this.#vmid)) : this.#fsfreeze_Status; }
    #fsfreeze_Thaw;
    /**
     * Get AgentVmidQemuNodeNodesFsfreeze_Thaw
     * @returns {PVEAgentVmidQemuNodeNodesFsfreeze_Thaw}
     */
    get fsfreeze_Thaw() { return this.#fsfreeze_Thaw == null ? (this.#fsfreeze_Thaw = new PVEAgentVmidQemuNodeNodesFsfreeze_Thaw(this.#client, this.#node, this.#vmid)) : this.#fsfreeze_Thaw; }
    #fstrim;
    /**
     ...
     * @returns {PVEAgentVmidQemuNodeNodesGet_Fsinfo}
     */
    get get_Fsinfo() { return this.#get_Fsinfo == null ? (this.#get_Fsinfo = new PVEAgentVmidQemuNodeNodesGet_Fsinfo(this.#client, this.#node, this.#vmid)) : this.#get_Fsinfo; }
    #get_Host_Name;
    /**
     * Get AgentVmidQemuNodeNodesGet_Host_Name
     * @returns {PVEAgentVmidQemuNodeNodesGet_Host_Name}
     */
    get get_Host_Name() { return this.#get_Host_Name == null ? (this.#get_Host_Name = new PVEAgentVmidQemuNodeNodesGet_Host_Name(this.#client, this.#node, this.#vmid)) : this.#get_Host_Name; }
    #get_Memory_Block_Info;
    /**
     * Get AgentVmidQemuNodeNodesGet_Memory_Block_Info
     * @returns {PVEAgentVmidQemuNodeNodesGet_Memory_Block_Info}
     */
    get get_Memory_Block_Info() { return this.#get_Memory_Block_Info == null ? (this.#get_Memory_Block_Info = new PVEAgentVmidQemuNodeNodesGet_Memory_Block_Info(this.#client, this.#node, this.#vmid)) : this.#get_Memory_Block_Info; }
    #get_Memory_Blocks;
    /**
     * Get AgentVmidQemuNodeNodesGet_Memory_Blocks
     * @returns {PVEAgentVmidQemuNodeNodesGet_Memory_Blocks}
     */
    get get_Memory_Blocks() { return this.#get_Memory_Blocks == null ? (this.#get_Memory_Blocks = new PVEAgentVmidQemuNodeNodesGet_Memory_Blocks(this.#client, this.#node, this.#vmid)) : this.#get_Memory_Blocks; }
    #get_Osinfo;
    /**
     * Get AgentVmidQemuNodeNodesGet_Osinfo
     * @returns {PVEAgentVmidQemuNodeNodesGet_Osinfo}
     */
    get get_Osinfo() { return this.#get_Osinfo == null ? (this.#get_Osinfo = new PVEAgentVmidQemuNodeNodesGet_Osinfo(this.#client, this.#node, this.#vmid)) : this.#get_Osinfo; }
    #get_Time;
    /**
     * Get AgentVmidQemuNodeNodesGet_Time
     * @returns {PVEAgentVmidQemuNodeNodesGet_Time}
     */
    get get_Time() { return this.#get_Time == null ? (this.#get_Time = new PVEAgentVmidQemuNodeNodesGet_Time(this.#client, this.#node, this.#vmid)) : this.#get_Time; }
    #get_Timezone;
    /**
     * Get AgentVmidQemuNodeNodesGet_Timezone
     * @returns {PVEAgentVmidQemuNodeNodesGet_Timezone}
     */
    get get_Timezone() { return this.#get_Timezone == null ? (this.#get_Timezone = new PVEAgentVmidQemuNodeNodesGet_Timezone(this.#client, this.#node, this.#vmid)) : this.#get_Timezone; }
    #get_Users;
    /**
     * Get AgentVmidQemuNodeNodesGet_Users
     * @returns {PVEAgentVmidQemuNodeNodesGet_Users}
     */
    get get_Users() { return this.#get_Users == null ? (this.#get_Users = new PVEAgentVmidQemuNodeNodesGet_Users(this.#client, this.#node, this.#vmid)) : this.#get_Users; }
    #get_Vcpus;
    /**
     * Get AgentVmidQemuNodeNodesGet_Vcpus
     * @returns {PVEAgentVmidQemuNodeNodesGet_Vcpus}
     */
    get get_Vcpus() { return this.#get_Vcpus == null ? (this.#get_Vcpus = new PVEAgentVmidQemuNodeNodesGet_Vcpus(this.#client, this.#node, this.#vmid)) : this.#get_Vcpus; }
    #info;
    /**
     ...
     * @returns {PVEAgentVmidQemuNodeNodesNetwork_Get_Interfaces}
     */
    get network_Get_Interfaces() { return this.#network_Get_Interfaces == null ? (this.#network_Get_Interfaces = new PVEAgentVmidQemuNodeNodesNetwork_Get_Interfaces(this.#client, this.#node, this.#vmid)) : this.#network_Get_Interfaces; }
    #ping;
    /**
     ...
     * @returns {PVEAgentVmidQemuNodeNodesSuspend_Disk}
     */
    get suspend_Disk() { return this.#suspend_Disk == null ? (this.#suspend_Disk = new PVEAgentVmidQemuNodeNodesSuspend_Disk(this.#client, this.#node, this.#vmid)) : this.#suspend_Disk; }
    #suspend_Hybrid;
    /**
     * Get AgentVmidQemuNodeNodesSuspend_Hybrid
     * @returns {PVEAgentVmidQemuNodeNodesSuspend_Hybrid}
     */
    get suspend_Hybrid() { return this.#suspend_Hybrid == null ? (this.#suspend_Hybrid = new PVEAgentVmidQemuNodeNodesSuspend_Hybrid(this.#client, this.#node, this.#vmid)) : this.#suspend_Hybrid; }
    #suspend_Ram;
    /**
     * Get AgentVmidQemuNodeNodesSuspend_Ram
     * @returns {PVEAgentVmidQemuNodeNodesSuspend_Ram}
     */
    get suspend_Ram() { return this.#suspend_Ram == null ? (this.#suspend_Ram = new PVEAgentVmidQemuNodeNodesSuspend_Ram(this.#client, this.#node, this.#vmid)) : this.#suspend_Ram; }
    #set_User_Password;
    /**
     * Get AgentVmidQemuNodeNodesSet_User_Password
     * @returns {PVEAgentVmidQemuNodeNodesSet_User_Password}
     */
    get set_User_Password() { return this.#set_User_Password == null ? (this.#set_User_Password = new PVEAgentVmidQemuNodeNodesSet_User_Password(this.#client, this.#node, this.#vmid)) : this.#set_User_Password; }
    #exec;
    /**
     ...
     * @returns {PVEAgentVmidQemuNodeNodesExec_Status}
     */
    get exec_Status() { return this.#exec_Status == null ? (this.#exec_Status = new PVEAgentVmidQemuNodeNodesExec_Status(this.#client, this.#node, this.#vmid)) : this.#exec_Status; }
    #file_Read;
    /**
     * Get AgentVmidQemuNodeNodesFile_Read
     * @returns {PVEAgentVmidQemuNodeNodesFile_Read}
     */
    get file_Read() { return this.#file_Read == null ? (this.#file_Read = new PVEAgentVmidQemuNodeNodesFile_Read(this.#client, this.#node, this.#vmid)) : this.#file_Read; }
    #file_Write;
    /**
     * Get AgentVmidQemuNodeNodesFile_Write
     * @returns {PVEAgentVmidQemuNodeNodesFile_Write}
     */
    get file_Write() { return this.#file_Write == null ? (this.#file_Write = new PVEAgentVmidQemuNodeNodesFile_Write(this.#client, this.#node, this.#vmid)) : this.#file_Write; }
    ...
    * @returns {Result}
    */
    async agent(command) { return await this.createRest(command); }
...
class PVEAgentVmidQemuNodeNodesFsfreeze_Freeze {
    ...
    * @returns {Result}
    */
    async fsfreeze_Freeze() { return await this.createRest(); }
...
class PVEAgentVmidQemuNodeNodesFsfreeze_Status {
    ...
    * @returns {Result}
    */
    async fsfreeze_Status() { return await this.createRest(); }
...
class PVEAgentVmidQemuNodeNodesFsfreeze_Thaw {
    ...
    * @returns {Result}
    */
    async fsfreeze_Thaw() { return await this.createRest(); }
...
class PVEAgentVmidQemuNodeNodesFstrim {
    ...
    * @returns {Result}
    */
    async fstrim() { return await this.createRest(); }
...
class PVEAgentVmidQemuNodeNodesGet_Fsinfo {
    ...
    * @returns {Result}
    */
    async get_Fsinfo() { return await this.getRest(); }
...
class PVEAgentVmidQemuNodeNodesGet_Host_Name {
    ...
    * @returns {Result}
    */
    async get_Host_Name() { return await this.getRest(); }
...
class PVEAgentVmidQemuNodeNodesGet_Memory_Block_Info {
    ...
    * @returns {Result}
    */
    async get_Memory_Block_Info() { return await this.getRest(); }
...
class PVEAgentVmidQemuNodeNodesGet_Memory_Blocks {
    ...
    * @returns {Result}
    */
    async get_Memory_Blocks() { return await this.getRest(); }
...
class PVEAgentVmidQemuNodeNodesGet_Osinfo {
    ...
    * @returns {Result}
    */
    async get_Osinfo() { return await this.getRest(); }
...
class PVEAgentVmidQemuNodeNodesGet_Time {
    ...
    * @returns {Result}
    */
    async get_Time() { return await this.getRest(); }
...
class PVEAgentVmidQemuNodeNodesGet_Timezone {
    ...
    * @returns {Result}
    */
    async get_Timezone() { return await this.getRest(); }
...
class PVEAgentVmidQemuNodeNodesGet_Users {
    ...
    * @returns {Result}
    */
    async get_Users() { return await this.getRest(); }
...
class PVEAgentVmidQemuNodeNodesGet_Vcpus {
    ...
    * @returns {Result}
    */
    async get_Vcpus() { return await this.getRest(); }
...
class PVEAgentVmidQemuNodeNodesInfo {
    ...
    * @returns {Result}
    */
    async info() { return await this.getRest(); }
...
class PVEAgentVmidQemuNodeNodesNetwork_Get_Interfaces {
    ...
    * @returns {Result}
    */
    async network_Get_Interfaces() { return await this.getRest(); }
...
class PVEAgentVmidQemuNodeNodesPing {
    ...
    * @returns {Result}
    */
    async ping() { return await this.createRest(); }
...
class PVEAgentVmidQemuNodeNodesShutdown {
    ...
    * @returns {Result}
    */
    async shutdown() { return await this.createRest(); }
...
class PVEAgentVmidQemuNodeNodesSuspend_Disk {
    ...
    * @returns {Result}
    */
    async suspend_Disk() { return await this.createRest(); }
...
class PVEAgentVmidQemuNodeNodesSuspend_Hybrid {
    ...
    * @returns {Result}
    */
    async suspend_Hybrid() { return await this.createRest(); }
...
class PVEAgentVmidQemuNodeNodesSuspend_Ram {
    ...
    * @returns {Result}
    */
    async suspend_Ram() { return await this.createRest(); }
...
class PVEAgentVmidQemuNodeNodesSet_User_Password {
    ...
    * @returns {Result}
    */
    async createRest(password, username, crypted) {
        var parameters = {
            'password': password,
            'username': username,
            'crypted': crypted
    ...
    * @returns {Result}
    */
    async set_User_Password(password, username, crypted) { return await this.createRest(password, username, crypted); }
...
class PVEAgentVmidQemuNodeNodesExec {
    ...
    * @returns {Result}
    */
    async createRest(command, input_data) {
        var parameters = {
            'command': command,
    ...
    * @returns {Result}
    */
    async exec(command, input_data) { return await this.createRest(command, input_data); }
...
class PVEAgentVmidQemuNodeNodesExec_Status {
    ...
    * @returns {Result}
    */
    async exec_Status(pid) { return await this.getRest(pid); }
...
class PVEAgentVmidQemuNodeNodesFile_Read {
    ...
    * @returns {Result}
    */
    async file_Read(file) { return await this.getRest(file); }
...
class PVEAgentVmidQemuNodeNodesFile_Write {
    ...
    * @returns {Result}
    */
    async file_Write(content, file) { return await this.createRest(content, file); }
...
class PVEVmidQemuNodeNodesRrd {
    ...
    * @returns {Result}
    */
    async rrd(ds, timeframe, cf) { return await this.getRest(ds, timeframe, cf); }
...
class PVEVmidQemuNodeNodesRrddata {
    ...
    * @returns {Result}
    */
    async rrddata(timeframe, cf) { return await this.getRest(timeframe, cf); }
...
class PVEVmidQemuNodeNodesConfig {
    ...
    * @returns {Result}
    */
    async getRest(current, snapshot) {
        var parameters = {
            'current': current,
            'snapshot': snapshot
        };
    ...
    * @returns {Result}
    */
    async vmConfig(current, snapshot) { return await this.getRest(current, snapshot); }
    /**
    ...
    * @returns {Result}
    */
    async updateVmAsync(acpi, agent, arch, args, audio0, autostart, background_delay, balloon, bios, boot, bootdisk, cdrom, cicustom, cipassword, citype, ciuser, cores, cpu, cpulimit, cpuunits, delete_, description, digest, efidisk0, force, freeze, hookscript, hostpciN, hotplug, hugepages, ideN, ipconfigN, ivshmem, keephugepages, keyboard, kvm, localtime, lock, machine, memory, migrate_downtime, migrate_speed, name, nameserver, netN, numa, numaN, onboot, ostype, parallelN, protection, reboot, revert, rng0, sataN, scsiN, scsihw, searchdomain, serialN, shares, skiplock, smbios1, smp, sockets, spice_enhancements, sshkeys, startdate, startup, tablet, tags, tdf, template, tpmstate0, unusedN, usbN, vcpus, vga, virtioN, vmgenid, vmstatestorage, watchdog) { return await this.createRest(acpi, agent, arch, args, audio0, autostart, background_delay, balloon, bios, boot, bootdisk, cdrom, cicustom, cipassword, citype, ciuser, cores, cpu, cpulimit, cpuunits, delete_, description, digest, efidisk0, force, freeze, hookscript, hostpciN, hotplug, hugepages, ideN, ipconfigN, ivshmem, keephugepages, keyboard, kvm, localtime, lock, machine, memory, migrate_downtime, migrate_speed, name, nameserver, netN, numa, numaN, onboot, ostype, parallelN, protection, reboot, revert, rng0, sataN, scsiN, scsihw, searchdomain, serialN, shares, skiplock, smbios1, smp, sockets, spice_enhancements, sshkeys, startdate, startup, tablet, tags, tdf, template, tpmstate0, unusedN, usbN, vcpus, vga, virtioN, vmgenid, vmstatestorage, watchdog); }
    /**
    ...
    * @returns {Result}
    */
    async updateVm(acpi, agent, arch, args, audio0, autostart, balloon, bios, boot, bootdisk, cdrom, cicustom, cipassword, citype, ciuser, cores, cpu, cpulimit, cpuunits, delete_, description, digest, efidisk0, force, freeze, hookscript, hostpciN, hotplug, hugepages, ideN, ipconfigN, ivshmem, keephugepages, keyboard, kvm, localtime, lock, machine, memory, migrate_downtime, migrate_speed, name, nameserver, netN, numa, numaN, onboot, ostype, parallelN, protection, reboot, revert, rng0, sataN, scsiN, scsihw, searchdomain, serialN, shares, skiplock, smbios1, smp, sockets, spice_enhancements, sshkeys, startdate, startup, tablet, tags, tdf, template, tpmstate0, unusedN, usbN, vcpus, vga, virtioN, vmgenid, vmstatestorage, watchdog) { return await this.setRest(acpi, agent, arch, args, audio0, autostart, balloon, bios, boot, bootdisk, cdrom, cicustom, cipassword, citype, ciuser, cores, cpu, cpulimit, cpuunits, delete_, description, digest, efidisk0, force, freeze, hookscript, hostpciN, hotplug, hugepages, ideN, ipconfigN, ivshmem, keephugepages, keyboard, kvm, localtime, lock, machine, memory, migrate_downtime, migrate_speed, name, nameserver, netN, numa, numaN, onboot, ostype, parallelN, protection, reboot, revert, rng0, sataN, scsiN, scsihw, searchdomain, serialN, shares, skiplock, smbios1, smp, sockets, spice_enhancements, sshkeys, startdate, startup, tablet, tags, tdf, template, tpmstate0, unusedN, usbN, vcpus, vga, virtioN, vmgenid, vmstatestorage, watchdog); }
...
class PVEVmidQemuNodeNodesPending {
    ...
    * @returns {Result}
    */
    async vmPending() { return await this.getRest(); }
...
class PVEVmidQemuNodeNodesUnlink {
    ...
    * @returns {Result}
    */
    async unlink(idlist, force) { return await this.setRest(idlist, force); }
...
class PVEVmidQemuNodeNodesVncproxy {
    ...
    * @returns {Result}
    */
    async createRest(generate_password, websocket) {
        var parameters = {
    ...
    * @returns {Result}
    */
    async vncproxy(generate_password, websocket) { return await this.createRest(generate_password, websocket); }
...
class PVEVmidQemuNodeNodesTermproxy {
    ...
    * @returns {Result}
    */
    async createRest(serial) {
        var parameters = { 'serial': serial };
    ...
    * @returns {Result}
    */
    async termproxy(serial) { return await this.createRest(serial); }
...
class PVEVmidQemuNodeNodesVncwebsocket {
    ...
    * @returns {Result}
    */
    async vncwebsocket(port, vncticket) { return await this.getRest(port, vncticket); }
...
class PVEVmidQemuNodeNodesSpiceproxy {
    ...
    * @returns {Result}
    */
    async createRest(proxy) {
        var parameters = { 'proxy': proxy };
    ...
    * @returns {Result}
    */
    async spiceproxy(proxy) { return await this.createRest(proxy); }
...
class PVEVmidQemuNodeNodesStatus {
    ...
    * @returns {Result}
    */
    async vmcmdidx() { return await this.getRest(); }
...
class PVEStatusVmidQemuNodeNodesCurrent {
    ...
    * @returns {Result}
    */
    async vmStatus() { return await this.getRest(); }
...
class PVEStatusVmidQemuNodeNodesStart {
    ...
    * @returns {Result}
    */
    async createRest(force_cpu, machine, migratedfrom, migration_network, migration_type, skiplock, stateuri, targetstorage, timeout) {
        var parameters = {
            'force-cpu': force_cpu,
            'machine': machine,
    ...
    * @returns {Result}
    */
    async vmStart(force_cpu, machine, migratedfrom, migration_network, migration_type, skiplock, stateuri, targetstorage, timeout) { return await this.createRest(force_cpu, machine, migratedfrom, migration_network, migration_type, skiplock, stateuri, targetstorage, timeout); }
...
class PVEStatusVmidQemuNodeNodesStop {
    ...
    * @returns {Result}
    */
    async createRest(keepActive, migratedfrom, skiplock, timeout) {
        var parameters = {
    ...
    * @returns {Result}
    */
    async vmStop(keepActive, migratedfrom, skiplock, timeout) { return await this.createRest(keepActive, migratedfrom, skiplock, timeout); }
...
class PVEStatusVmidQemuNodeNodesReset {
    ...
    * @returns {Result}
    */
    async createRest(skiplock) {
        var parameters = { 'skiplock': skiplock };
    ...
    * @returns {Result}
    */
    async vmReset(skiplock) { return await this.createRest(skiplock); }
...
class PVEStatusVmidQemuNodeNodesShutdown {
    ...
    * @returns {Result}
    */
    async createRest(forceStop, keepActive, skiplock, timeout) {
        var parameters = {
            'forceStop': forceStop,
            'keepActive': keepActive,
            'skiplock': skiplock,
    ...
    * @returns {Result}
    */
    async vmShutdown(forceStop, keepActive, skiplock, timeout) { return await this.createRest(forceStop, keepActive, skiplock, timeout); }
...
class PVEStatusVmidQemuNodeNodesReboot {
    ...
    * @returns {Result}
    */
    async createRest(timeout) {
        var parameters = { 'timeout': timeout };
    ...
    * @returns {Result}
    */
    async vmReboot(timeout) { return await this.createRest(timeout); }
...
class PVEStatusVmidQemuNodeNodesSuspend {
    ...
    * @returns {Result}
    */
    async createRest(skiplock, statestorage, todisk) {
        var parameters = {
            'skiplock': skiplock,
    ...
    * @returns {Result}
    */
    async vmSuspend(skiplock, statestorage, todisk) { return await this.createRest(skiplock, statestorage, todisk); }
...
class PVEStatusVmidQemuNodeNodesResume {
    ...
    * @returns {Result}
    */
    async createRest(nocheck, skiplock) {
        var parameters = {
            'nocheck': nocheck,
            'skiplock': skiplock
        };
    ...
    * @returns {Result}
    */
    async vmResume(nocheck, skiplock) { return await this.createRest(nocheck, skiplock); }
...
class PVEVmidQemuNodeNodesSendkey {
    ...
    * @returns {Result}
    */
    async vmSendkey(key, skiplock) { return await this.setRest(key, skiplock); }
...
class PVEVmidQemuNodeNodesFeature {
    ...
    * @returns {Result}
    */
    async getRest(feature, snapname) {
        var parameters = {
            'feature': feature,
            'snapname': snapname
        };
    ...
    * @returns {Result}
    */
    async vmFeature(feature, snapname) { return await this.getRest(feature, snapname); }
...
class PVEVmidQemuNodeNodesClone {
    ...
    * @returns {Result}
    */
    async createRest(newid, bwlimit, description, format, full, name, pool, snapname, storage, target) {
        var parameters = {
            'newid': newid,
            'bwlimit': bwlimit,
            'description': description,
    ...
    * @returns {Result}
    */
    async cloneVm(newid, bwlimit, description, format, full, name, pool, snapname, storage, target) { return await this.createRest(newid, bwlimit, description, format, full, name, pool, snapname, storage, target); }
...
class PVEVmidQemuNodeNodesMoveDisk {
    ...
    * @returns {Result}
    */
    async createRest(disk, bwlimit, delete_, digest, format, storage, target_digest, target_disk, target_vmid) {
        var parameters = {
            'disk': disk,
            'bwlimit': bwlimit,
            'delete': delete_,
    ...
    * @returns {Result}
    */
    async moveVmDisk(disk, bwlimit, delete_, digest, format, storage, target_digest, target_disk, target_vmid) { return await this.createRest(disk, bwlimit, delete_, digest, format, storage, target_digest, target_disk, target_vmid); }
...
class PVEVmidQemuNodeNodesMigrate {
    ...
    * @returns {Result}
    */
    async migrateVmPrecondition(target) { return await this.getRest(target); }
    /**
    ...
    * @returns {Result}
    */
    async createRest(target, bwlimit, force, migration_network, migration_type, online, targetstorage, with_local_disks) {
        var parameters = {
            'target': target,
            'bwlimit': bwlimit,
            'force': force,
    ...
    * @returns {Result}
    */
    async migrateVm(target, bwlimit, force, migration_network, migration_type, online, targetstorage, with_local_disks) { return await this.createRest(target, bwlimit, force, migration_network, migration_type, online, targetstorage, with_local_disks); }
...
class PVEVmidQemuNodeNodesMonitor {
    ...
    * @returns {Result}
    */
    async monitor(command) { return await this.createRest(command); }
...
class PVEVmidQemuNodeNodesResize {
    ...
    * @returns {Result}
    */
    async setRest(disk, size, digest, skiplock) {
        var parameters = {
            'disk': disk,
            'size': size,
            'digest': digest,
    ...
    * @returns {Result}
    */
    async resizeVm(disk, size, digest, skiplock) { return await this.setRest(disk, size, digest, skiplock); }
...
class PVEVmidQemuNodeNodesSnapshot {
    ...
    * @returns {Result}
    */
    async snapshotList() { return await this.getRest(); }
    /**
    * Snapshot a VM.
    * @param {string} snapname The name of the snapshot.
    ...
    * @returns {Result}
    */
    async createRest(snapname, description, vmstate) {
        var parameters = {
            'snapname': snapname,
            'description': description,
            'vmstate': vmstate
    ...
    * @returns {Result}
    */
    async snapshot(snapname, description, vmstate) { return await this.createRest(snapname, description, vmstate); }
...
class PVEItemSnapshotVmidQemuNodeNodesSnapname {
    ...
    * @returns {Result}
    */
    async deleteRest(force) {
        var parameters = { 'force': force };
    ...
    * @returns {Result}
    */
    async delsnapshot(force) { return await this.deleteRest(force); }
    /**
    *
    * @returns {Result}
    */
    ...
    * @returns {Result}
    */
    async snapshotCmdIdx() { return await this.getRest(); }
...
class PVESnapnameSnapshotVmidQemuNodeNodesConfig {
    ...
    * @returns {Result}
    */
    async getSnapshotConfig() { return await this.getRest(); }
    /**
    * Update snapshot metadata.
    * @param {string} description A textual description or comment.
    * @returns {Result}
    */
    async setRest(description) {
    ...
    * @returns {Result}
    */
    async updateSnapshotConfig(description) { return await this.setRest(description); }
...
class PVESnapnameSnapshotVmidQemuNodeNodesRollback {
    ...
    * @returns {Result}
    */
    async rollback() { return await this.createRest(); }
...
class PVEVmidQemuNodeNodesTemplate {
    ...
    * @returns {Result}
    */
    async createRest(disk) {
        var parameters = { 'disk': disk };
    ...
    * @returns {Result}
    */
    async template(disk) { return await this.createRest(disk); }
...
class PVECloudinitVmidQemuNodeNodesDump {
    ...
    * @returns {Result}
    */
    async cloudinitGeneratedConfigDump(type) { return await this.getRest(type); }
...
class PVENodeNodesLxc {
    ...
    * @returns {Result}
    */
    async vmlist() { return await this.getRest(); }
    /**
    ...
    * @returns {Result}
    */
    async createVm(ostemplate, vmid, arch, bwlimit, cmode, console, cores, cpulimit, cpuunits, debug, description, features, force, hookscript, hostname, ignore_unpack_errors, lock, memory, mpN, nameserver, netN, onboot, ostype, password, pool, protection, restore, rootfs, searchdomain, ssh_public_keys, start, startup, storage, swap, tags, template, timezone, tty, unique, unprivileged, unusedN) { return await this.createRest(ostemplate, vmid, arch, bwlimit, cmode, console, cores, cpulimit, cpuunits, debug, description, features, force, hookscript, hostname, ignore_unpack_errors, lock, memory, mpN, nameserver, netN, onboot, ostype, password, pool, protection, restore, rootfs, searchdomain, ssh_public_keys, start, startup, storage, swap, tags, template, timezone, tty, unique, unprivileged, unusedN); }
...
class PVEItemLxcNodeNodesVmid {
    ...
    * @returns {Result}
    */
    async deleteRest(destroy_unreferenced_disks, force, purge) {
        var parameters = {
            'destroy-unreferenced-disks': destroy_unreferenced_disks,
            'force': force,
            'purge': purge
    ...
    * @returns {Result}
    */
    async destroyVm(destroy_unreferenced_disks, force, purge) { return await this.deleteRest(destroy_unreferenced_disks, force, purge); }
    /**
    * Directory index
    * @returns {Result}
    */
...
class PVEVmidLxcNodeNodesConfig {
    ...
    * @returns {Result}
    */
    async setRest(arch, cmode, console, cores, cpulimit, cpuunits, debug, delete_, description, digest, features, hookscript, hostname, lock, memory, mpN, nameserver, netN, onboot, ostype, protection, revert, rootfs, searchdomain, startup, swap, tags, template, timezone, tty, unprivileged, unusedN) {
        var parameters = {
            'arch': arch,
            'cmode': cmode,
            'console': console,
    ...
    * @returns {Result}
    */
    async updateVm(arch, cmode, console, cores, cpulimit, cpuunits, debug, delete_, description, digest, features, hookscript, hostname, lock, memory, mpN, nameserver, netN, onboot, ostype, protection, revert, rootfs, searchdomain, startup, swap, tags, template, timezone, tty, unprivileged, unusedN) { return await this.setRest(arch, cmode, console, cores, cpulimit, cpuunits, debug, delete_, description, digest, features, hookscript, hostname, lock, memory, mpN, nameserver, netN, onboot, ostype, protection, revert, rootfs, searchdomain, startup, swap, tags, template, timezone, tty, unprivileged, unusedN); }
...
class PVEStatusVmidLxcNodeNodesStart {
    ...
    * @returns {Result}
    */
    async createRest(debug, skiplock) {
        var parameters = {
            'debug': debug,
            'skiplock': skiplock
        };
    ...
    * @returns {Result}
    */
    async vmStart(debug, skiplock) { return await this.createRest(debug, skiplock); }
...
class PVEStatusVmidLxcNodeNodesStop {
    ...
    * @returns {Result}
    */
    async vmStop(skiplock) { return await this.createRest(skiplock); }
...
class PVEStatusVmidLxcNodeNodesShutdown {
    ...
    * @returns {Result}
    */
    async createRest(forceStop, timeout) {
        var parameters = {
            'forceStop': forceStop,
            'timeout': timeout
        };
    ...
    * @returns {Result}
    */
    async vmShutdown(forceStop, timeout) { return await this.createRest(forceStop, timeout); }
...
class PVEStatusVmidLxcNodeNodesSuspend {
    ...
    * @returns {Result}
    */
    async vmSuspend() { return await this.createRest(); }
...
class PVEStatusVmidLxcNodeNodesResume {
    ...
    * @returns {Result}
    */
    async vmResume() { return await this.createRest(); }
...
class PVEVmidLxcNodeNodesSnapshot {
    ...
    * @returns {Result}
    */
    async list() { return await this.getRest(); }
    /**
    ...
    * @returns {Result}
    */
    async createRest(snapname, description) {
        var parameters = {
            'snapname': snapname,
            'description': description
        };
    ...
    * @returns {Result}
    */
    async snapshot(snapname, description) { return await this.createRest(snapname, description); }
...
class PVEVmidLxcNodeNodesVncproxy {
    ...
    * @returns {Result}
    */
    async createRest(height, websocket, width) {
        var parameters = {
            'height': height,
            'websocket': websocket,
            'width': width
    ...
    * @returns {Result}
    */
    async vncproxy(height, websocket, width) { return await this.createRest(height, websocket, width); }
...
class PVEVmidLxcNodeNodesTermproxy {
    ...
    * @returns {Result}
    */
    async termproxy() { return await this.createRest(); }
...
class PVEVmidLxcNodeNodesMigrate {
    ...
    * @returns {Result}
    */
    async createRest(target, bwlimit, online, restart, timeout) {
        var parameters = {
            'target': target,
            'bwlimit': bwlimit,
            'online': online,
    ...
    * @returns {Result}
    */
    async migrateVm(target, bwlimit, online, restart, timeout) { return await this.createRest(target, bwlimit, online, restart, timeout); }
...
class PVEVmidLxcNodeNodesTemplate {
    ...
    * @returns {Result}
    */
    async template() { return await this.createRest(); }
...
class PVEVmidLxcNodeNodesClone {
    ...
    * @returns {Result}
    */
    async createRest(newid, bwlimit, description, full, hostname, pool, snapname, storage, target) {
        var parameters = {
            'newid': newid,
            'bwlimit': bwlimit,
            'description': description,
    ...
    * @returns {Result}
    */
    async cloneVm(newid, bwlimit, description, full, hostname, pool, snapname, storage, target) { return await this.createRest(newid, bwlimit, description, full, hostname, pool, snapname, storage, target); }
...
class PVEVmidLxcNodeNodesResize {
    ...
    * @returns {Result}
    */
    async setRest(disk, size, digest) {
        var parameters = {
            'disk': disk,
            'size': size,
            'digest': digest
    ...
    * @returns {Result}
    */
    async resizeVm(disk, size, digest) { return await this.setRest(disk, size, digest); }
...
class PVEVmidLxcNodeNodesMoveVolume {
    ...
    * @returns {Result}
    */
    async createRest(volume, bwlimit, delete_, digest, storage, target_digest, target_vmid, target_volume) {
        var parameters = {
            'volume': volume,
            'bwlimit': bwlimit,
            'delete': delete_,
    ...
    * @returns {Result}
    */
    async moveVolume(volume, bwlimit, delete_, digest, storage, target_digest, target_vmid, target_volume) { return await this.createRest(volume, bwlimit, delete_, digest, storage, target_digest, target_vmid, target_volume); }
...
class PVECephNodeNodesOsd {
    ...
    * @returns {Result}
    */
    async createRest(dev, crush_device_class, db_dev, db_dev_size, encrypted, wal_dev, wal_dev_size) {
        var parameters = {
            'dev': dev,
    ...
    * @returns {Result}
    */
    async createosd(dev, crush_device_class, db_dev, db_dev_size, encrypted, wal_dev, wal_dev_size) { return await this.createRest(dev, crush_device_class, db_dev, db_dev_size, encrypted, wal_dev, wal_dev_size); }
...
class PVEItemOsdCephNodeNodesOsdid {
    ...
    * @returns {Result}
    */
    async deleteRest(cleanup) {
        var parameters = { 'cleanup': cleanup };
    ...
    * @returns {Result}
    */
    async destroyosd(cleanup) { return await this.deleteRest(cleanup); }
...
class PVEOsdidOsdCephNodeNodesIn {
    ...
    * @returns {Result}
    */
    async in() { return await this.createRest(); }
...
class PVEOsdidOsdCephNodeNodesOut {
    ...
    * @returns {Result}
    */
    async out() { return await this.createRest(); }
...
class PVEOsdidOsdCephNodeNodesScrub {
    ...
    * @returns {Result}
    */
    async createRest(deep) {
        var parameters = { 'deep': deep };
    ...
    * @returns {Result}
    */
    async scrub(deep) { return await this.createRest(deep); }
...
class PVEItemMdsCephNodeNodesName {
    ...
    * @returns {Result}
    */
    async destroymds() { return await this.deleteRest(); }
    /**
    ...
    * @returns {Result}
    */
    async createRest(hotstandby) {
        var parameters = { 'hotstandby': hotstandby };
    ...
    * @returns {Result}
    */
    async createmds(hotstandby) { return await this.createRest(hotstandby); }
...
class PVEItemMgrCephNodeNodesId {
    ...
    * @returns {Result}
    */
    async destroymgr() { return await this.deleteRest(); }
    /**
    * Create Ceph Manager
    * @returns {Result}
    */
    ...
    * @returns {Result}
    */
    async createmgr() { return await this.createRest(); }
...
class PVECephNodeNodesMon {
    ...
    * @returns {Result}
    */
    async listmon() { return await this.getRest(); }
...
class PVEItemMonCephNodeNodesMonid {
    ...
    * @returns {Result}
    */
    async createmon(mon_address) { return await this.createRest(mon_address); }
...
class PVEItemFsCephNodeNodesName {
    ...
    * @returns {Result}
    */
    async createRest(add_storage, pg_num) {
        var parameters = {
    ...
    * @returns {Result}
    */
    async createfs(add_storage, pg_num) { return await this.createRest(add_storage, pg_num); }
...
class PVECephNodeNodesPools {
    ...
    * @returns {Result}
    */
    async lspools() { return await this.getRest(); }
    /**
    * Create POOL
    ...
    * @returns {Result}
    */
    async createRest(name, add_storages, application, crush_rule, min_size, pg_autoscale_mode, pg_num, pg_num_min, size, target_size, target_size_ratio) {
        var parameters = {
            'name': name,
    ...
    * @returns {Result}
    */
    async createpool(name, add_storages, application, crush_rule, min_size, pg_autoscale_mode, pg_num, pg_num_min, size, target_size, target_size_ratio) { return await this.createRest(name, add_storages, application, crush_rule, min_size, pg_autoscale_mode, pg_num, pg_num_min, size, target_size, target_size_ratio); }
...
class PVEItemPoolsCephNodeNodesName {
    ...
    * @returns {Result}
    */
    async deleteRest(force, remove_storages) {
        var parameters = {
            'force': force,
    ...
    * @returns {Result}
    */
    async destroypool(force, remove_storages) { return await this.deleteRest(force, remove_storages); }
    /**
    * List pool settings.
    * @param {bool} verbose If enabled, will display additional data(eg. statistics).
    * @returns {Result}
    */
    async getRest(verbose) {
        var parameters = { 'verbose': verbose };
    ...
    * @returns {Result}
    */
    async getpool(verbose) { return await this.getRest(verbose); }
    /**
    ...
    * @returns {Result}
    */
    async setRest(application, crush_rule, min_size, pg_autoscale_mode, pg_num, pg_num_min, size, target_size, target_size_ratio) {
        var parameters = {
            'application': application,
            'crush_rule': crush_rule,
            'min_size': min_size,
    ...
    * @returns {Result}
    */
    async setpool(application, crush_rule, min_size, pg_autoscale_mode, pg_num, pg_num_min, size, target_size, target_size_ratio) { return await this.setRest(application, crush_rule, min_size, pg_autoscale_mode, pg_num, pg_num_min, size, target_size, target_size_ratio); }
...
class PVECephNodeNodesConfig {
    ...
    * @returns {Result}
    */
    async config() { return await this.getRest(); }
...
class PVECephNodeNodesConfigdb {
    ...
    * @returns {Result}
    */
    async configdb() { return await this.getRest(); }
...
class PVECephNodeNodesInit {
    ...
    * @returns {Result}
    */
    async createRest(cluster_network, disable_cephx, min_size, network, pg_bits, size) {
        var parameters = {
    ...
    * @returns {Result}
    */
    async init(cluster_network, disable_cephx, min_size, network, pg_bits, size) { return await this.createRest(cluster_network, disable_cephx, min_size, network, pg_bits, size); }
...
class PVECephNodeNodesStop {
    ...
    * @returns {Result}
    */
    async stop(service) { return await this.createRest(service); }
...
class PVECephNodeNodesStart {
    ...
    * @returns {Result}
    */
    async start(service) { return await this.createRest(service); }
...
class PVECephNodeNodesRestart {
    ...
    * @returns {Result}
    */
    async restart(service) { return await this.createRest(service); }
...
class PVECephNodeNodesCrush {
    ...
    * @returns {Result}
    */
    async crush() { return await this.getRest(); }
...
class PVECephNodeNodesRules {
    ...
    * @returns {Result}
    */
    async rules() { return await this.getRest(); }
...
class PVENodeNodesVzdump {
    ...
    * @returns {Result}
    */
    async createRest(all, bwlimit, compress, dumpdir, exclude, exclude_path, ionice, lockwait, mailnotification, mailto, maxfiles, mode, pigz, pool, prune_backups, quiet, remove, script, stdexcludes, stdout, stop, stopwait, storage, tmpdir, vmid, zstd) {
        var parameters = {
            'all': all,
            'bwlimit': bwlimit,
            'compress': compress,
    ...
    * @returns {Result}
    */
    async vzdump(all, bwlimit, compress, dumpdir, exclude, exclude_path, ionice, lockwait, mailnotification, mailto, maxfiles, mode, pigz, pool, prune_backups, quiet, remove, script, stdexcludes, stdout, stop, stopwait, storage, tmpdir, vmid, zstd) { return await this.createRest(all, bwlimit, compress, dumpdir, exclude, exclude_path, ionice, lockwait, mailnotification, mailto, maxfiles, mode, pigz, pool, prune_backups, quiet, remove, script, stdexcludes, stdout, stop, stopwait, storage, tmpdir, vmid, zstd); }
...
class PVEVzdumpNodeNodesDefaults {
    ...
    * @returns {Result}
    */
    async getRest(storage) {
        var parameters = { 'storage': storage };
    ...
    * @returns {Result}
    */
    async defaults(storage) { return await this.getRest(storage); }
...
class PVEVzdumpNodeNodesExtractconfig {
    ...
    * @returns {Result}
    */
    async extractconfig(volume) { return await this.getRest(volume); }
...
class PVEItemServicesNodeNodesService {
    ...
    * @returns {Result}
    */
    async srvcmdidx() { return await this.getRest(); }
...
class PVEServiceServicesNodeNodesState {
    ...
    * @returns {Result}
    */
    async serviceState() { return await this.getRest(); }
...
class PVEServiceServicesNodeNodesStart {
    ...
    * @returns {Result}
    */
    async serviceStart() { return await this.createRest(); }
...
class PVEServiceServicesNodeNodesStop {
    ...
    * @returns {Result}
    */
    async serviceStop() { return await this.createRest(); }
...
class PVEServiceServicesNodeNodesRestart {
    ...
    * @returns {Result}
    */
    async serviceRestart() { return await this.createRest(); }
...
class PVEServiceServicesNodeNodesReload {
    ...
    * @returns {Result}
    */
    async serviceReload() { return await this.createRest(); }
...
class PVENodeNodesSubscription {
    ...
    * @returns {Result}
    */
    async update(force) { return await this.createRest(force); }
    /**
    ...
    * @returns {Result}
    */
    async set(key) { return await this.setRest(key); }
...
class PVENodeNodesNetwork {
    ...
    * @returns {Result}
    */
    async revertNetworkChanges() { return await this.deleteRest(); }
    /**
    ...
    * @returns {Result}
    */
    async createRest(iface, type, address, address6, autostart, bond_primary, bond_mode, bond_xmit_hash_policy, bridge_ports, bridge_vlan_aware, cidr, cidr6, comments, comments6, gateway, gateway6, mtu, netmask, netmask6, ovs_bonds, ovs_bridge, ovs_options, ovs_ports, ovs_tag, slaves, vlan_id, vlan_raw_device) {
        var parameters = {
            'iface': iface,
            'type': type,
            'address': address,
    ...
    * @returns {Result}
    */
    async createNetwork(iface, type, address, address6, autostart, bond_primary, bond_mode, bond_xmit_hash_policy, bridge_ports, bridge_vlan_aware, cidr, cidr6, comments, comments6, gateway, gateway6, mtu, netmask, netmask6, ovs_bonds, ovs_bridge, ovs_options, ovs_ports, ovs_tag, slaves, vlan_id, vlan_raw_device) { return await this.createRest(iface, type, address, address6, autostart, bond_primary, bond_mode, bond_xmit_hash_policy, bridge_ports, bridge_vlan_aware, cidr, cidr6, comments, comments6, gateway, gateway6, mtu, netmask, netmask6, ovs_bonds, ovs_bridge, ovs_options, ovs_ports, ovs_tag, slaves, vlan_id, vlan_raw_device); }
    /**
    ...
    * @returns {Result}
    */
    async reloadNetworkConfig() { return await this.setRest(); }
...
class PVEItemNetworkNodeNodesIface {
    ...
    * @returns {Result}
    */
    async deleteNetwork() { return await this.deleteRest(); }
    /**
    ...
    * @returns {Result}
    */
    async networkConfig() { return await this.getRest(); }
    /**
    ...
    * @returns {Result}
    */
    async setRest(type, address, address6, autostart, bond_primary, bond_mode, bond_xmit_hash_policy, bridge_ports, bridge_vlan_aware, cidr, cidr6, comments, comments6, delete_, gateway, gateway6, mtu, netmask, netmask6, ovs_bonds, ovs_bridge, ovs_options, ovs_ports, ovs_tag, slaves, vlan_id, vlan_raw_device) {
        var parameters = {
            'type': type,
            'address': address,
            'address6': address6,
    ...
    * @returns {Result}
    */
    async updateNetwork(type, address, address6, autostart, bond_primary, bond_mode, bond_xmit_hash_policy, bridge_ports, bridge_vlan_aware, cidr, cidr6, comments, comments6, delete_, gateway, gateway6, mtu, netmask, netmask6, ovs_bonds, ovs_bridge, ovs_options, ovs_ports, ovs_tag, slaves, vlan_id, vlan_raw_device) { return await this.setRest(type, address, address6, autostart, bond_primary, bond_mode, bond_xmit_hash_policy, bridge_ports, bridge_vlan_aware, cidr, cidr6, comments, comments6, delete_, gateway, gateway6, mtu, netmask, netmask6, ovs_bonds, ovs_bridge, ovs_options, ovs_ports, ovs_tag, slaves, vlan_id, vlan_raw_device); }
...
class PVENodeNodesTasks {
    ...
    * @returns {Result}
    */
    async getRest(errors, limit, since, source, start, statusfilter, typefilter, until, userfilter, vmid) {
        var parameters = {
            'errors': errors,
            'limit': limit,
            'since': since,
    ...
    * @returns {Result}
    */
    async nodeTasks(errors, limit, since, source, start, statusfilter, typefilter, until, userfilter, vmid) { return await this.getRest(errors, limit, since, source, start, statusfilter, typefilter, until, userfilter, vmid); }
...
class PVEItemTasksNodeNodesUpid {
    ...
    * @returns {Result}
    */
    async stopTask() { return await this.deleteRest(); }
    /**
    *
    * @returns {Result}
    */
    ...
    * @returns {Result}
    */
    async upidIndex() { return await this.getRest(); }
...
class PVEUpidTasksNodeNodesLog {
    ...
    * @returns {Result}
    */
    async readTaskLog(limit, start) { return await this.getRest(limit, start); }
...
class PVEUpidTasksNodeNodesStatus {
    ...
    * @returns {Result}
    */
    async readTaskStatus() { return await this.getRest(); }
...
class PVEScanNodeNodesNfs {
    ...
    * @returns {Result}
    */
    async nfsscan(server) { return await this.getRest(server); }
...
class PVEScanNodeNodesCifs {
    ...
    * @returns {Result}
    */
    async getRest(server, domain, password, username) {
        var parameters = {
            'server': server,
            'domain': domain,
            'password': password,
    ...
    * @returns {Result}
    */
    async cifsscan(server, domain, password, username) { return await this.getRest(server, domain, password, username); }
...
class PVEScanNodeNodesPbs {
    ...
    * @returns {Result}
    */
    async getRest(password, server, username, fingerprint, port) {
        var parameters = {
            'password': password,
            'server': server,
            'username': username,
    ...
    * @returns {Result}
    */
    async pbsscan(password, server, username, fingerprint, port) { return await this.getRest(password, server, username, fingerprint, port); }
...
class PVEScanNodeNodesGlusterfs {
    ...
    * @returns {Result}
    */
    async glusterfsscan(server) { return await this.getRest(server); }
...
class PVEScanNodeNodesIscsi {
    ...
    * @returns {Result}
    */
    async getRest(portal) {
        var parameters = { 'portal': portal };
    ...
    * @returns {Result}
    */
    async iscsiscan(portal) { return await this.getRest(portal); }
...
class PVEScanNodeNodesLvm {
    ...
    * @returns {Result}
    */
    async lvmscan() { return await this.getRest(); }
...
class PVEScanNodeNodesLvmthin {
    ...
    * @returns {Result}
    */
    async lvmthinscan(vg) { return await this.getRest(vg); }
...
class PVEScanNodeNodesZfs {
    ...
    * @returns {Result}
    */
    async zfsscan() { return await this.getRest(); }
...
class PVEHardwareNodeNodesPci {
    ...
    * @returns {Result}
    */
    async getRest(pci_class_blacklist, verbose) {
        var parameters = {
    ...
    * @returns {Result}
    */
    async pciscan(pci_class_blacklist, verbose) { return await this.getRest(pci_class_blacklist, verbose); }
...
class PVEItemPciHardwareNodeNodesPciid {
    ...
    * @returns {Result}
    */
    async pciindex() { return await this.getRest(); }
...
class PVEPciidPciHardwareNodeNodesMdev {
    ...
    * @returns {Result}
    */
    async mdevscan() { return await this.getRest(); }
...
class PVEHardwareNodeNodesUsb {
    ...
    * @returns {Result}
    */
    async usbscan() { return await this.getRest(); }
...
class PVECapabilitiesNodeNodesQemu {
    ...
    * @returns {Result}
    */
    async qemuCapsIndex() { return await this.getRest(); }
...
class PVEQemuCapabilitiesNodeNodesMachines {
    ...
    * @returns {Result}
    */
    async types() { return await this.getRest(); }
...
class PVENodeNodesStorage {
    ...
    * @returns {Result}
    */
    async getRest(content, enabled, format, storage, target) {
        var parameters = {
            'content': content,
            'enabled': enabled,
            'format': format,
    ...
    * @returns {Result}
    */
    async index(content, enabled, format, storage, target) { return await this.getRest(content, enabled, format, storage, target); }
...
class PVEItemStorageNodeNodesStorage {
     ...
     * @returns {PVEStorageStorageNodeNodesFile_Restore}
     */
    get file_Restore() { return this.#file_Restore == null ? (this.#file_Restore = new PVEStorageStorageNodeNodesFile_Restore(this.#client, this.#node, this.#storage)) : this.#file_Restore; }
    #status;
    /**
     ...
     * @returns {PVEStorageStorageNodeNodesDownload_Url}
     */
    get download_Url() { return this.#download_Url == null ? (this.#download_Url = new PVEStorageStorageNodeNodesDownload_Url(this.#client, this.#node, this.#storage)) : this.#download_Url; }
    ...
    * @returns {Result}
    */
    async diridx() { return await this.getRest(); }
...
class PVEStorageStorageNodeNodesPrunebackups {
    ...
    * @returns {Result}
    */
    async deleteRest(prune_backups, type, vmid) {
        var parameters = {
            'prune-backups': prune_backups,
            'type': type,
            'vmid': vmid
    ...
    * @returns {Result}
    */
    async delete_(prune_backups, type, vmid) { return await this.deleteRest(prune_backups, type, vmid); }
    /**
    ...
    * @returns {Result}
    */
    async getRest(prune_backups, type, vmid) {
        var parameters = {
            'prune-backups': prune_backups,
            'type': type,
            'vmid': vmid
    ...
    * @returns {Result}
    */
    async dryrun(prune_backups, type, vmid) { return await this.getRest(prune_backups, type, vmid); }
...
class PVEStorageStorageNodeNodesContent {
    ...
    * @returns {Result}
    */
    async index(content, vmid) { return await this.getRest(content, vmid); }
    /**
    ...
    * @returns {Result}
    */
    async createRest(filename, size, vmid, format) {
        var parameters = {
            'filename': filename,
            'size': size,
            'vmid': vmid,
    ...
    * @returns {Result}
    */
    async create(filename, size, vmid, format) { return await this.createRest(filename, size, vmid, format); }
...
class PVEItemContentStorageStorageNodeNodesVolume {
    ...
    * @returns {Result}
    */
    async delete_(delay) { return await this.deleteRest(delay); }
    /**
    ...
    * @returns {Result}
    */
    async createRest(target, target_node) {
        var parameters = {
            'target': target,
    ...
    * @returns {Result}
    */
    async copy(target, target_node) { return await this.createRest(target, target_node); }
    /**
    ...
    * @returns {Result}
    */
    async setRest(notes, protected_) {
        var parameters = {
            'notes': notes,
    ...
    * @returns {Result}
    */
    async updateattributes(notes, protected_) { return await this.setRest(notes, protected_); }
...
class PVEStorageStorageNodeNodesFile_Restore {
     ...
     * @returns {PVEFile_RestoreStorageStorageNodeNodesList}
     */
    get list() { return this.#list == null ? (this.#list = new PVEFile_RestoreStorageStorageNodeNodesList(this.#client, this.#node, this.#storage)) : this.#list; }
    #download;
    /**
     * Get File_RestoreStorageStorageNodeNodesDownload
     * @returns {PVEFile_RestoreStorageStorageNodeNodesDownload}
     */
    get download() { return this.#download == null ? (this.#download = new PVEFile_RestoreStorageStorageNodeNodesDownload(this.#client, this.#node, this.#storage)) : this.#download; }
...
class PVEFile_RestoreStorageStorageNodeNodesList {
    ...
    * @returns {Result}
    */
    async list(filepath, volume) { return await this.getRest(filepath, volume); }
...
class PVEFile_RestoreStorageStorageNodeNodesDownload {
    ...
    * @returns {Result}
    */
    async download(filepath, volume) { return await this.getRest(filepath, volume); }
...
class PVEStorageStorageNodeNodesStatus {
    ...
    * @returns {Result}
    */
    async readStatus() { return await this.getRest(); }
...
class PVEStorageStorageNodeNodesUpload {
    ...
    * @returns {Result}
    */
    async createRest(content, filename, checksum, checksum_algorithm, tmpfilename) {
        var parameters = {
            'content': content,
            'filename': filename,
            'checksum': checksum,
    ...
    * @returns {Result}
    */
    async upload(content, filename, checksum, checksum_algorithm, tmpfilename) { return await this.createRest(content, filename, checksum, checksum_algorithm, tmpfilename); }
...
class PVEStorageStorageNodeNodesDownload_Url {
    ...
    * @returns {Result}
    */
    async createRest(content, filename, url, checksum, checksum_algorithm, verify_certificates) {
        var parameters = {
            'content': content,
            'filename': filename,
            'url': url,
    ...
    * @returns {Result}
    */
    async downloadUrl(content, filename, url, checksum, checksum_algorithm, verify_certificates) { return await this.createRest(content, filename, url, checksum, checksum_algorithm, verify_certificates); }
...
class PVEDisksNodeNodesLvm {
    ...
    * @returns {Result}
    */
    async createRest(device, name, add_storage) {
        var parameters = {
            'device': device,
            'name': name,
    ...
    * @returns {Result}
    */
    async create(device, name, add_storage) { return await this.createRest(device, name, add_storage); }
...
class PVEItemLvmDisksNodeNodesName {
    ...
    * @returns {Result}
    */
    async deleteRest(cleanup_config, cleanup_disks) {
        var parameters = {
    ...
    * @returns {Result}
    */
    async delete_(cleanup_config, cleanup_disks) { return await this.deleteRest(cleanup_config, cleanup_disks); }
...
class PVEItemLvmthinDisksNodeNodesName {
    ...
    * @returns {Result}
    */
    async deleteRest(volume_group, cleanup_config, cleanup_disks) {
        var parameters = {
    ...
    * @returns {Result}
    */
    async delete_(volume_group, cleanup_config, cleanup_disks) { return await this.deleteRest(volume_group, cleanup_config, cleanup_disks); }
...
class PVEDisksNodeNodesDirectory {
    ...
    * @returns {Result}
    */
    async createRest(device, name, add_storage, filesystem) {
        var parameters = {
            'device': device,
            'name': name,
            'add_storage': add_storage,
    ...
    * @returns {Result}
    */
    async create(device, name, add_storage, filesystem) { return await this.createRest(device, name, add_storage, filesystem); }
...
class PVEDisksNodeNodesZfs {
    ...
    * @returns {Result}
    */
    async createRest(devices, name, raidlevel, add_storage, ashift, compression) {
        var parameters = {
            'devices': devices,
            'name': name,
            'raidlevel': raidlevel,
    ...
    * @returns {Result}
    */
    async create(devices, name, raidlevel, add_storage, ashift, compression) { return await this.createRest(devices, name, raidlevel, add_storage, ashift, compression); }
...
class PVEItemZfsDisksNodeNodesName {
    ...
    * @returns {Result}
    */
    async detail() { return await this.getRest(); }
...
class PVEDisksNodeNodesList {
    ...
    * @returns {Result}
    */
    async getRest(include_partitions, skipsmart, type) {
        var parameters = {
    ...
    * @returns {Result}
    */
    async list(include_partitions, skipsmart, type) { return await this.getRest(include_partitions, skipsmart, type); }
...
class PVEDisksNodeNodesSmart {
    ...
    * @returns {Result}
    */
    async smart(disk, healthonly) { return await this.getRest(disk, healthonly); }
...
class PVEDisksNodeNodesInitgpt {
    ...
    * @returns {Result}
    */
    async initgpt(disk, uuid) { return await this.createRest(disk, uuid); }
...
class PVEDisksNodeNodesWipedisk {
    ...
    * @returns {Result}
    */
    async wipeDisk(disk) { return await this.setRest(disk); }
...
class PVEAptNodeNodesUpdate {
    ...
    * @returns {Result}
    */
    async listUpdates() { return await this.getRest(); }
    /**
    ...
    * @returns {Result}
    */
    async updateDatabase(notify, quiet) { return await this.createRest(notify, quiet); }
...
class PVEAptNodeNodesChangelog {
    ...
    * @returns {Result}
    */
    async changelog(name, version) { return await this.getRest(name, version); }
...
class PVEAptNodeNodesRepositories {
    ...
    * @returns {Result}
    */
    async repositories() { return await this.getRest(); }
    /**
    ...
    * @returns {Result}
    */
    async createRest(index, path, digest, enabled) {
        var parameters = {
            'index': index,
            'path': path,
            'digest': digest,
    ...
    * @returns {Result}
    */
    async changeRepository(index, path, digest, enabled) { return await this.createRest(index, path, digest, enabled); }
    /**
    ...
    * @returns {Result}
    */
    async addRepository(handle, digest) { return await this.setRest(handle, digest); }
...
class PVEAptNodeNodesVersions {
    ...
    * @returns {Result}
    */
    async versions() { return await this.getRest(); }
...
class PVEFirewallNodeNodesOptions {
    ...
    * @returns {Result}
    */
    async setOptions(delete_, digest, enable, log_level_in, log_level_out, log_nf_conntrack, ndp, nf_conntrack_allow_invalid, nf_conntrack_max, nf_conntrack_tcp_timeout_established, nf_conntrack_tcp_timeout_syn_recv, nosmurfs, protection_synflood, protection_synflood_burst, protection_synflood_rate, smurf_log_level, tcp_flags_log_level, tcpflags) { return await this.setRest(delete_, digest, enable, log_level_in, log_level_out, log_nf_conntrack, ndp, nf_conntrack_allow_invalid, nf_conntrack_max, nf_conntrack_tcp_timeout_established, nf_conntrack_tcp_timeout_syn_recv, nosmurfs, protection_synflood, protection_synflood_burst, protection_synflood_rate, smurf_log_level, tcp_flags_log_level, tcpflags); }
...
class PVENodeNodesReplication {
    ...
    * @returns {Result}
    */
    async status(guest) { return await this.getRest(guest); }
...
class PVEIdReplicationNodeNodesStatus {
    ...
    * @returns {Result}
    */
    async jobStatus() { return await this.getRest(); }
...
class PVEIdReplicationNodeNodesLog {
    ...
    * @returns {Result}
    */
    async readJobLog(limit, start) { return await this.getRest(limit, start); }
...
class PVEIdReplicationNodeNodesScheduleNow {
    ...
    * @returns {Result}
    */
    async scheduleNow() { return await this.createRest(); }
...
class PVEAcmeCertificatesNodeNodesCertificate {
    ...
    * @returns {Result}
    */
    async revokeCertificate() { return await this.deleteRest(); }
    /**
    ...
    * @returns {Result}
    */
    async newCertificate(force) { return await this.createRest(force); }
    /**
    ...
    * @returns {Result}
    */
    async renewCertificate(force) { return await this.setRest(force); }
...
class PVECertificatesNodeNodesCustom {
    ...
    * @returns {Result}
    */
    async deleteRest(restart) {
        var parameters = { 'restart': restart };
    ...
    * @returns {Result}
    */
    async removeCustomCert(restart) { return await this.deleteRest(restart); }
    /**
    ...
    * @returns {Result}
    */
    async createRest(certificates, force, key, restart) {
        var parameters = {
    ...
    * @returns {Result}
    */
    async uploadCustomCert(certificates, force, key, restart) { return await this.createRest(certificates, force, key, restart); }
...
class PVENodeNodesConfig {
    ...
    * @returns {Result}
    */
    async getRest(property) {
        var parameters = { 'property': property };
    ...
    * @returns {Result}
    */
    async getConfig(property) { return await this.getRest(property); }
    /**
    ...
    * @returns {Result}
    */
    async setRest(acme, acmedomainN, delete_, description, digest, startall_onboot_delay, wakeonlan) {
        var parameters = {
            'acme': acme,
            'delete': delete_,
            'description': description,
    ...
    * @returns {Result}
    */
    async setOptions(acme, acmedomainN, delete_, description, digest, startall_onboot_delay, wakeonlan) { return await this.setRest(acme, acmedomainN, delete_, description, digest, startall_onboot_delay, wakeonlan); }
...
class PVENodeNodesSdn {
    ...
    * @returns {Result}
    */
    async sdnindex() { return await this.getRest(); }
...
class PVENodeNodesVersion {
    ...
    * @returns {Result}
    */
    async version() { return await this.getRest(); }
...
class PVENodeNodesStatus {
    ...
    * @returns {Result}
    */
    async nodeCmd(command) { return await this.createRest(command); }
...
class PVENodeNodesNetstat {
    ...
    * @returns {Result}
    */
    async netstat() { return await this.getRest(); }
...
class PVENodeNodesExecute {
    ...
    * @returns {Result}
    */
    async createRest(commands) {
        var parameters = { 'commands': commands };
    ...
    * @returns {Result}
    */
    async execute(commands) { return await this.createRest(commands); }
...
class PVENodeNodesWakeonlan {
    ...
    * @returns {Result}
    */
    async wakeonlan() { return await this.createRest(); }
...
class PVENodeNodesSyslog {
    ...
    * @returns {Result}
    */
    async getRest(limit, service, since, start, until) {
        var parameters = {
            'limit': limit,
            'service': service,
            'since': since,
    ...
    * @returns {Result}
    */
    async syslog(limit, service, since, start, until) { return await this.getRest(limit, service, since, start, until); }
...
class PVENodeNodesJournal {
    ...
    * @returns {Result}
    */
    async getRest(endcursor, lastentries, since, startcursor, until) {
        var parameters = {
            'endcursor': endcursor,
    ...
    * @returns {Result}
    */
    async journal(endcursor, lastentries, since, startcursor, until) { return await this.getRest(endcursor, lastentries, since, startcursor, until); }
...
class PVENodeNodesVncshell {
    ...
    * @returns {Result}
    */
    async createRest(cmd, cmd_opts, height, websocket, width) {
        var parameters = {
            'cmd': cmd,
            'cmd-opts': cmd_opts,
            'height': height,
    ...
    * @returns {Result}
    */
    async vncshell(cmd, cmd_opts, height, websocket, width) { return await this.createRest(cmd, cmd_opts, height, websocket, width); }
...
class PVENodeNodesTermproxy {
    ...
    * @returns {Result}
    */
    async termproxy(cmd, cmd_opts) { return await this.createRest(cmd, cmd_opts); }
...
class PVENodeNodesSpiceshell {
    ...
    * @returns {Result}
    */
    async createRest(cmd, cmd_opts, proxy) {
        var parameters = {
            'cmd': cmd,
            'cmd-opts': cmd_opts,
            'proxy': proxy
    ...
    * @returns {Result}
    */
    async spiceshell(cmd, cmd_opts, proxy) { return await this.createRest(cmd, cmd_opts, proxy); }
...
class PVENodeNodesDns {
    ...
    * @returns {Result}
    */
    async dns() { return await this.getRest(); }
    /**
    * Write DNS settings.
    ...
    * @returns {Result}
    */
    async setRest(search, dns1, dns2, dns3) {
        var parameters = {
            'search': search,
            'dns1': dns1,
            'dns2': dns2,
    ...
    * @returns {Result}
    */
    async updateDns(search, dns1, dns2, dns3) { return await this.setRest(search, dns1, dns2, dns3); }
...
class PVENodeNodesTime {
    ...
    * @returns {Result}
    */
    async setTimezone(timezone) { return await this.setRest(timezone); }
...
class PVENodeNodesAplinfo {
    ...
    * @returns {Result}
    */
    async aplinfo() { return await this.getRest(); }
    /**
    ...
    * @returns {Result}
    */
    async createRest(storage, template) {
        var parameters = {
            'storage': storage,
            'template': template
        };
    ...
    * @returns {Result}
    */
    async aplDownload(storage, template) { return await this.createRest(storage, template); }

}

/**
 * Class PVENodeNodesQuery_Url_Metadata
 */
class PVENodeNodesQuery_Url_Metadata {
    #node;
    /** @type {PveClient} */
    ...
    * @returns {Result}
    */
    async getRest(url, verify_certificates) {
        var parameters = {
            'url': url,
            'verify-certificates': verify_certificates
        };
    ...
    * @returns {Result}
    */
    async queryUrlMetadata(url, verify_certificates) { return await this.getRest(url, verify_certificates); }
...
class PVENodeNodesReport {
    ...
    * @returns {Result}
    */
    async report() { return await this.getRest(); }
...
class PVENodeNodesStartall {
    ...
    * @returns {Result}
    */
    async startall(force, vms) { return await this.createRest(force, vms); }
...
class PVENodeNodesStopall {
    ...
    * @returns {Result}
    */
    async createRest(vms) {
        var parameters = { 'vms': vms };
    ...
    * @returns {Result}
    */
    async stopall(vms) { return await this.createRest(vms); }
...
class PVENodeNodesMigrateall {
    ...
    * @returns {Result}
    */
    async createRest(target, maxworkers, vms, with_local_disks) {
        var parameters = {
            'target': target,
    ...
    * @returns {Result}
    */
    async migrateall(target, maxworkers, vms, with_local_disks) { return await this.createRest(target, maxworkers, vms, with_local_disks); }
...
class PVENodeNodesHosts {
    ...
    * @returns {Result}
    */
    async getEtcHosts() { return await this.getRest(); }
    /**
    * Write /etc/hosts.
    ...
    * @returns {Result}
    */
    async writeEtcHosts(data, digest) { return await this.createRest(data, digest); }
...
class PVEStorage {
    ...
    * @returns {Result}
    */
    async createRest(storage, type, authsupported, base, blocksize, bwlimit, comstar_hg, comstar_tg, content, datastore, disable, domain, encryption_key, export_, fingerprint, format, fs_name, fuse, is_mountpoint, iscsiprovider, keyring, krbd, lio_tpg, master_pubkey, maxfiles, mkdir, monhost, mountpoint, namespace, nocow, nodes, nowritecache, options, password, path, pool, port, portal, preallocation, prune_backups, saferemove, saferemove_throughput, server, server2, share, shared, smbversion, sparse, subdir, tagged_only, target, thinpool, transport, username, vgname, volume) {
        var parameters = {
            'storage': storage,
            'type': type,
    ...
    * @returns {Result}
    */
    async create(storage, type, authsupported, base, blocksize, bwlimit, comstar_hg, comstar_tg, content, datastore, disable, domain, encryption_key, export_, fingerprint, format, fs_name, fuse, is_mountpoint, iscsiprovider, keyring, krbd, lio_tpg, master_pubkey, maxfiles, mkdir, monhost, mountpoint, namespace, nocow, nodes, nowritecache, options, password, path, pool, port, portal, preallocation, prune_backups, saferemove, saferemove_throughput, server, server2, share, shared, smbversion, sparse, subdir, tagged_only, target, thinpool, transport, username, vgname, volume) { return await this.createRest(storage, type, authsupported, base, blocksize, bwlimit, comstar_hg, comstar_tg, content, datastore, disable, domain, encryption_key, export_, fingerprint, format, fs_name, fuse, is_mountpoint, iscsiprovider, keyring, krbd, lio_tpg, master_pubkey, maxfiles, mkdir, monhost, mountpoint, namespace, nocow, nodes, nowritecache, options, password, path, pool, port, portal, preallocation, prune_backups, saferemove, saferemove_throughput, server, server2, share, shared, smbversion, sparse, subdir, tagged_only, target, thinpool, transport, username, vgname, volume); }
...
class PVEItemStorageStorage {
    ...
    * @returns {Result}
    */
    async update(blocksize, bwlimit, comstar_hg, comstar_tg, content, delete_, digest, disable, domain, encryption_key, fingerprint, format, fs_name, fuse, is_mountpoint, keyring, krbd, lio_tpg, master_pubkey, maxfiles, mkdir, monhost, mountpoint, namespace, nocow, nodes, nowritecache, options, password, pool, port, preallocation, prune_backups, saferemove, saferemove_throughput, server, server2, shared, smbversion, sparse, subdir, tagged_only, transport, username) { return await this.setRest(blocksize, bwlimit, comstar_hg, comstar_tg, content, delete_, digest, disable, domain, encryption_key, fingerprint, format, fs_name, fuse, is_mountpoint, keyring, krbd, lio_tpg, master_pubkey, maxfiles, mkdir, monhost, mountpoint, namespace, nocow, nodes, nowritecache, options, password, pool, port, preallocation, prune_backups, saferemove, saferemove_throughput, server, server2, shared, smbversion, sparse, subdir, tagged_only, transport, username); }
...
class PVEAccessUsers {
    ...
    * @returns {Result}
    */
    async index(enabled, full) { return await this.getRest(enabled, full); }
    /**
    * Create new user.
    ...
    * @returns {Result}
    */
    async createRest(userid, comment, email, enable, expire, firstname, groups, keys, lastname, password) {
        var parameters = {
            'userid': userid,
            'comment': comment,
            'email': email,
    ...
    * @returns {Result}
    */
    async createUser(userid, comment, email, enable, expire, firstname, groups, keys, lastname, password) { return await this.createRest(userid, comment, email, enable, expire, firstname, groups, keys, lastname, password); }
...
class PVEItemUsersAccessUserid {
    ...
    * @returns {Result}
    */
    async deleteUser() { return await this.deleteRest(); }
    /**
    ...
    * @returns {Result}
    */
    async readUser() { return await this.getRest(); }
    /**
    ...
    * @returns {Result}
    */
    async setRest(append, comment, email, enable, expire, firstname, groups, keys, lastname) {
        var parameters = {
            'append': append,
            'comment': comment,
            'email': email,
    ...
    * @returns {Result}
    */
    async updateUser(append, comment, email, enable, expire, firstname, groups, keys, lastname) { return await this.setRest(append, comment, email, enable, expire, firstname, groups, keys, lastname); }
...
class PVEUseridUsersAccessTfa {
    ...
    * @returns {Result}
    */
    async getRest(multiple) {
        var parameters = { 'multiple': multiple };
    ...
    * @returns {Result}
    */
    async readUserTfaType(multiple) { return await this.getRest(multiple); }
...
class PVEUseridUsersAccessToken {
    ...
    * @returns {Result}
    */
    async tokenIndex() { return await this.getRest(); }
...
class PVEItemTokenUseridUsersAccessTokenid {
    ...
    * @returns {Result}
    */
    async removeToken() { return await this.deleteRest(); }
    /**
    ...
    * @returns {Result}
    */
    async readToken() { return await this.getRest(); }
    /**
    ...
    * @returns {Result}
    */
    async createRest(comment, expire, privsep) {
        var parameters = {
            'comment': comment,
            'expire': expire,
            'privsep': privsep
    ...
    * @returns {Result}
    */
    async generateToken(comment, expire, privsep) { return await this.createRest(comment, expire, privsep); }
    /**
    ...
    * @returns {Result}
    */
    async setRest(comment, expire, privsep) {
        var parameters = {
            'comment': comment,
            'expire': expire,
            'privsep': privsep
    ...
    * @returns {Result}
    */
    async updateTokenInfo(comment, expire, privsep) { return await this.setRest(comment, expire, privsep); }
...
class PVEAccessGroups {
    ...
    * @returns {Result}
    */
    async createRest(groupid, comment) {
        var parameters = {
            'groupid': groupid,
            'comment': comment
        };
    ...
    * @returns {Result}
    */
    async createGroup(groupid, comment) { return await this.createRest(groupid, comment); }
...
class PVEItemGroupsAccessGroupid {
    ...
    * @returns {Result}
    */
    async deleteGroup() { return await this.deleteRest(); }
    /**
    ...
    * @returns {Result}
    */
    async readGroup() { return await this.getRest(); }
    /**
    * Update group data.
    * @param {string} comment
    * @returns {Result}
    */
    async setRest(comment) {
    ...
    * @returns {Result}
    */
    async updateGroup(comment) { return await this.setRest(comment); }
...
class PVEAccessRoles {
    ...
    * @returns {Result}
    */
    async createRole(roleid, privs) { return await this.createRest(roleid, privs); }
...
class PVEItemRolesAccessRoleid {
    ...
    * @returns {Result}
    */
    async deleteRole() { return await this.deleteRest(); }
    /**
    ...
    * @returns {Result}
    */
    async readRole() { return await this.getRest(); }
    /**
    ...
    * @returns {Result}
    */
    async updateRole(append, privs) { return await this.setRest(append, privs); }
...
class PVEAccessAcl {
    ...
    * @returns {Result}
    */
    async readAcl() { return await this.getRest(); }
    /**
    ...
    * @returns {Result}
    */
    async setRest(path, roles, delete_, groups, propagate, tokens, users) {
        var parameters = {
            'path': path,
            'roles': roles,
            'delete': delete_,
    ...
    * @returns {Result}
    */
    async updateAcl(path, roles, delete_, groups, propagate, tokens, users) { return await this.setRest(path, roles, delete_, groups, propagate, tokens, users); }
...
class PVEAccessDomains {
    ...
    * @returns {Result}
    */
    async create(realm, type, autocreate, base_dn, bind_dn, capath, case_sensitive, cert, certkey, client_id, client_key, comment, default_, domain, filter, group_classes, group_dn, group_filter, group_name_attr, issuer_url, mode, password, port, secure, server1, server2, sslversion, sync_defaults_options, sync_attributes, tfa, user_attr, user_classes, username_claim, verify) { return await this.createRest(realm, type, autocreate, base_dn, bind_dn, capath, case_sensitive, cert, certkey, client_id, client_key, comment, default_, domain, filter, group_classes, group_dn, group_filter, group_name_attr, issuer_url, mode, password, port, secure, server1, server2, sslversion, sync_defaults_options, sync_attributes, tfa, user_attr, user_classes, username_claim, verify); }
...
class PVEItemDomainsAccessRealm {
    ...
    * @returns {Result}
    */
    async update(autocreate, base_dn, bind_dn, capath, case_sensitive, cert, certkey, client_id, client_key, comment, default_, delete_, digest, domain, filter, group_classes, group_dn, group_filter, group_name_attr, issuer_url, mode, password, port, secure, server1, server2, sslversion, sync_defaults_options, sync_attributes, tfa, user_attr, user_classes, verify) { return await this.setRest(autocreate, base_dn, bind_dn, capath, case_sensitive, cert, certkey, client_id, client_key, comment, default_, delete_, digest, domain, filter, group_classes, group_dn, group_filter, group_name_attr, issuer_url, mode, password, port, secure, server1, server2, sslversion, sync_defaults_options, sync_attributes, tfa, user_attr, user_classes, verify); }
...
class PVERealmDomainsAccessSync {
    ...
    * @returns {Result}
    */
    async createRest(dry_run, enable_new, full, purge, scope) {
        var parameters = {
            'dry-run': dry_run,
    ...
    * @returns {Result}
    */
    async sync(dry_run, enable_new, full, purge, scope) { return await this.createRest(dry_run, enable_new, full, purge, scope); }
...
class PVEAccessOpenid {
     ...
     * @returns {PVEOpenidAccessAuth_Url}
     */
    get auth_Url() { return this.#auth_Url == null ? (this.#auth_Url = new PVEOpenidAccessAuth_Url(this.#client)) : this.#auth_Url; }
    #login;
    /**
...
class PVEOpenidAccessAuth_Url {
    ...
    * @returns {Result}
    */
    async createRest(realm, redirect_url) {
        var parameters = {
            'realm': realm,
    ...
    * @returns {Result}
    */
    async authUrl(realm, redirect_url) { return await this.createRest(realm, redirect_url); }
...
class PVEOpenidAccessLogin {
    ...
    * @returns {Result}
    */
    async createRest(code, redirect_url, state) {
        var parameters = {
            'code': code,
            'redirect-url': redirect_url,
            'state': state
    ...
    * @returns {Result}
    */
    async login(code, redirect_url, state) { return await this.createRest(code, redirect_url, state); }
...
class PVEAccessTfa {
    ...
    * @returns {Result}
    */
    async listTfa() { return await this.getRest(); }
    /**
    * Finish a u2f challenge.
    * @param {string} response The response to the current authentication challenge.
    * @returns {Result}
    */
    async createRest(response) {
        var parameters = { 'response': response };
    ...
    * @returns {Result}
    */
    async verifyTfa(response) { return await this.createRest(response); }
...
class PVEItemTfaAccessUserid {
    ...
    * @returns {Result}
    */
    async listUserTfa() { return await this.getRest(); }
    /**
    ...
    * @returns {Result}
    */
    async createRest(type, challenge, description, password, totp, value) {
        var parameters = {
            'type': type,
            'challenge': challenge,
            'description': description,
    ...
    * @returns {Result}
    */
    async addTfaEntry(type, challenge, description, password, totp, value) { return await this.createRest(type, challenge, description, password, totp, value); }
...
class PVEItemUseridTfaAccessId {
    ...
    * @returns {Result}
    */
    async deleteTfa(password) { return await this.deleteRest(password); }
    /**
    ...
    * @returns {Result}
    */
    async getTfaEntry() { return await this.getRest(); }
    /**
    * Add a TFA entry for a user.
    * @param {string} description A description to distinguish multiple entries from one another
    ...
    * @returns {Result}
    */
    async setRest(description, enable, password) {
        var parameters = {
            'description': description,
            'enable': enable,
            'password': password
    ...
    * @returns {Result}
    */
    async updateTfaEntry(description, enable, password) { return await this.setRest(description, enable, password); }
...
class PVEAccessTicket {
    ...
    * @returns {Result}
    */
    async getTicket() { return await this.getRest(); }
    /**
    ...
    * @returns {Result}
    */
    async createRest(password, username, new_format, otp, path, privs, realm, tfa_challenge) {
        var parameters = {
            'password': password,
            'username': username,
    ...
    * @returns {Result}
    */
    async createTicket(password, username, new_format, otp, path, privs, realm, tfa_challenge) { return await this.createRest(password, username, new_format, otp, path, privs, realm, tfa_challenge); }
...
class PVEAccessPassword {
    ...
    * @returns {Result}
    */
    async changePassword(password, userid) { return await this.setRest(password, userid); }
...
class PVEAccessPermissions {
    ...
    * @returns {Result}
    */
    async permissions(path, userid) { return await this.getRest(path, userid); }
...
class PVEPools {
    ...
    * @returns {Result}
    */
    async createRest(poolid, comment) {
        var parameters = {
            'poolid': poolid,
            'comment': comment
        };
    ...
    * @returns {Result}
    */
    async createPool(poolid, comment) { return await this.createRest(poolid, comment); }
...
class PVEItemPoolsPoolid {
    ...
    * @returns {Result}
    */
    async deletePool() { return await this.deleteRest(); }
    /**
    ...
    * @returns {Result}
    */
    async readPool() { return await this.getRest(); }
    /**
    * Update pool data.
    * @param {string} comment
    ...
    * @returns {Result}
    */
    async setRest(comment, delete_, storage, vms) {
        var parameters = {
            'comment': comment,
            'delete': delete_,
            'storage': storage,
    ...
    * @returns {Result}
    */
    async updatePool(comment, delete_, storage, vms) { return await this.setRest(comment, delete_, storage, vms); }
