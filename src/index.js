...
class PVENodeNodesCeph {
  ...
  get pools() {
    return this.#pools == null
      ? (this.#pools = new PVECephNodeNodesPools(this.#client, this.#node))
      : this.#pools;
  }
  #config;
  /**
  ...
  get config() {
    return this.#config == null
      ? (this.#config = new PVECephNodeNodesConfig(this.#client, this.#node))
      : this.#config;
  }
  #configdb;
  /**
  ...
  get configdb() {
    return this.#configdb == null
      ? (this.#configdb = new PVECephNodeNodesConfigdb(
          this.#client,
          this.#node
        ))
      : this.#configdb;
...
class PVEItemPoolsCephNodeNodesName {
  ...
  async destroypool(force, remove_ecprofile, remove_storages) {
    ...
    return await this.#client.delete(
      `/nodes/${this.#node}/ceph/pools/${this.#name}`,
      parameters
    );
  }
  /**
