// @ts-nocheck
// This file is auto-generated. Type checking is disabled because the generated
// code does not carry type annotations. Hand-written code lives in index.js.
...
const { PveClientBase, Result, ResponseType } = require("./index.js");
...
class PVECluster {
  ...
  /**
   * Get ClusterQemu
   * @returns {PVEClusterQemu}
   */
  get qemu() {
    return this.#qemu == null ? (this.#qemu = new PVEClusterQemu(this.#client)) : this.#qemu;
  }
  #config;
  /**
   * Get ClusterConfig
...
class PVEClusterQemu {
   ...
   * @returns {PVEQemuClusterCpuFlags}
   */
  get cpuFlags() {
    return this.#cpuFlags == null
      ? (this.#cpuFlags = new PVEQemuClusterCpuFlags(this.#client))
      : this.#cpuFlags;
  }
  #customCpuModels;
  /**
   * Get QemuClusterCustomCpuModels
   * @returns {PVEQemuClusterCustomCpuModels}
   */
  get customCpuModels() {
    return this.#customCpuModels == null
      ? (this.#customCpuModels = new PVEQemuClusterCustomCpuModels(this.#client))
      : this.#customCpuModels;
  }
   ...
   */
  async index() {
    return await this.#client.get(`/cluster/qemu`);
  }
}
/**
...
class PVEQemuClusterCustomCpuModels {
   ...
   * @param cputype
   * @returns {PVEItemCustomCpuModelsQemuClusterCputype}
   */
  get(cputype) {
   ...
   */
  async config() {
    return await this.#client.get(`/cluster/qemu/custom-cpu-models`);
  }
  /**
  ...
  async create(
    ...
    return await this.#client.create(`/cluster/qemu/custom-cpu-models`, parameters);
  }
}
/**
...
class PVEHaClusterStatus {
   ...
   * @returns {PVEStatusHaClusterDisarmHa}
   */
  get disarmHa() {
    return this.#disarmHa == null
      ? (this.#disarmHa = new PVEStatusHaClusterDisarmHa(this.#client))
      : this.#disarmHa;
  }
  #armHa;
  /**
   * Get StatusHaClusterArmHa
   * @returns {PVEStatusHaClusterArmHa}
   */
  get armHa() {
    return this.#armHa == null
      ? (this.#armHa = new PVEStatusHaClusterArmHa(this.#client))
      : this.#armHa;
  }
...
class PVEStatusHaClusterDisarmHa {
   ...
   * @returns {Promise<Result>}
   */
  async disarmHa(resource_mode) {
    const parameters = { "resource-mode": resource_mode };
    return await this.#client.create(`/cluster/ha/status/disarm-ha`, parameters);
  }
}
...
class PVEStatusHaClusterArmHa {
   ...
   */
  async armHa() {
    return await this.#client.create(`/cluster/ha/status/arm-ha`);
  }
}
...
class PVEClusterSdn {
   ...
   * @returns {PVESdnClusterPrefixLists}
   */
  get prefixLists() {
    return this.#prefixLists == null
      ? (this.#prefixLists = new PVESdnClusterPrefixLists(this.#client))
      : this.#prefixLists;
  }
  #routeMaps;
  /**
   * Get SdnClusterRouteMaps
   * @returns {PVESdnClusterRouteMaps}
   */
  get routeMaps() {
    return this.#routeMaps == null
      ? (this.#routeMaps = new PVESdnClusterRouteMaps(this.#client))
      : this.#routeMaps;
  }
  #lock;
  /**
   ...
   * @returns {PVESdnClusterDryRun}
   */
  get dryRun() {
    return this.#dryRun == null
      ? (this.#dryRun = new PVESdnClusterDryRun(this.#client))
      : this.#dryRun;
  }
...
class PVESdnClusterPrefixLists {
   ...
   * @param id
   * @returns {PVEItemPrefixListsSdnClusterId}
   */
  get(id) {
...
class PVEItemPrefixListsSdnClusterId {
   ...
   * @returns {PVEIdPrefixListsSdnClusterEntries}
   */
  get entries() {
    return this.#entries == null
      ? (this.#entries = new PVEIdPrefixListsSdnClusterEntries(this.#client, this.#id))
      : this.#entries;
  }
...
class PVEIdPrefixListsSdnClusterEntries {
   ...
   * @param url_seq
   * @returns {PVEItemEntriesIdPrefixListsSdnClusterUrlSeq}
   */
  get(url_seq) {
...
class PVESdnClusterRouteMaps {
   ...
   * @returns {PVERouteMapsSdnClusterEntries}
   */
  get entries() {
    return this.#entries == null
      ? (this.#entries = new PVERouteMapsSdnClusterEntries(this.#client))
      : this.#entries;
  }
  ...
  async listRouteMaps(running) {
    const parameters = { running: running };
    return await this.#client.get(`/cluster/sdn/route-maps`, parameters);
  }
}
/**
...
class PVERouteMapsSdnClusterEntries {
   ...
   * @param route_map_id
   * @returns {PVEItemEntriesRouteMapsSdnClusterRouteMapId}
   */
  get(route_map_id) {
  ...
  async createRouteMapEntry(
    ...
    return await this.#client.create(`/cluster/sdn/route-maps/entries`, parameters);
  }
}
/**
...
class PVEItemEntriesRouteMapsSdnClusterRouteMapId {
  ...
  constructor(client, route_map_id) {
    this.#client = client;
   ...
   * @returns {PVERouteMapIdEntriesRouteMapsSdnClusterEntry}
   */
  get entry() {
    return this.#entry == null
      ? (this.#entry = new PVERouteMapIdEntriesRouteMapsSdnClusterEntry(
          this.#client,
          this.#route_map_id
        ))
      : this.#entry;
...
class PVERouteMapIdEntriesRouteMapsSdnClusterEntry {
   ...
   * @param order
   * @returns {PVEItemEntryRouteMapIdEntriesRouteMapsSdnClusterOrder}
   */
  get(order) {
    return new PVEItemEntryRouteMapIdEntriesRouteMapsSdnClusterOrder(
      this.#client,
      this.#route_map_id,
      order
    );
...
class PVEItemEntryRouteMapIdEntriesRouteMapsSdnClusterOrder {
  ...
  constructor(client, route_map_id, order) {
    this.#client = client;
    this.#route_map_id = route_map_id;
    this.#order = order;
  }
...
class PVESdnClusterDryRun {
  ...
  async dryRun(node) {
    const parameters = { node: node };
    return await this.#client.get(`/cluster/sdn/dry-run`, parameters);
  }
}
...
class PVEItemStorageNodeNodesStorage {
   ...
   * @returns {PVEStorageStorageNodeNodesIdentity}
   */
  get identity() {
    return this.#identity == null
      ? (this.#identity = new PVEStorageStorageNodeNodesIdentity(
          this.#client,
          this.#node,
          this.#storage
        ))
...
class PVENodeNodesVncwebsocket {
  ...
  /**
   * Opens a websocket for VNC traffic.
   * @param {number} port Port number returned by previous 'vncshell' call.
